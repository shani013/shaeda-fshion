      ...
      <section className="flat-spacing-17 pt_0 flat-testimonial">
        <div className="container">
          ...
          <div className="wrap-carousel">
            <div dir="ltr" className="swiper tf-sw-testimonial" data-preview={3} data-tablet={2} data-mobile={1} data-space-lg={30} data-space-md={15}>
                    ...
                    <div className="product">
                      <div className="image">
                        <a href="product-detail.html">
                          <img className="lazyload" data-src="/assets/images/shop/products/img-p2.png" src="/assets/images/shop/products/img-p2.png" alt />
                        </a>
                      </div>
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item style-column">
                    ...
                    <div className="product">
                      <div className="image">
                        <a href="product-detail.html">
                          <img className="lazyload" data-src="/assets/images/shop/products/img-p3.png" src="/assets/images/shop/products/img-p3.png" alt />
                        </a>
                      </div>
                      <div className="content-wrap">
                        <div className="product-title">
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item style-column">
                    ...
                    <div className="product">
                      <div className="image">
                        <a href="product-detail.html">
                          <img className="lazyload" data-src="/assets/images/shop/products/img-p4.png" src="/assets/images/shop/products/img-p4.png" alt />
                        </a>
                      </div>
                      <div className="content-wrap">
                        <div className="product-title">
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item style-column">
                    ...
                    <div className="product">
                      <div className="image">
                        <a href="product-detail.html">
                          <img className="lazyload" data-src="/assets/images/shop/products/img-p5.png" src="/assets/images/shop/products/img-p5.png" alt />
                        </a>
                      </div>
                      <div className="content-wrap">
                        <div className="product-title">
