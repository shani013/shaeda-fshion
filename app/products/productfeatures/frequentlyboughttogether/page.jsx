...
export default function page() {
  return (
    <div>
                  ...
                  <div className="tf-product-info-wrap sticky-top">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-pickup-availability">
                        <div>
                          <svg width={18} height={18} viewBox="0 0 18 18" className="mt_3">
                            <path d="M7.6 13.2L14.65 6.15L13.25 4.75L7.6 10.4L4.75 7.55L3.35 8.95L7.6 13.2ZM0 18V0H18V18H0ZM2 16H16V2H2V16Z" fill="#428445" />
                          </svg>
                        </div>
                        <div>
                          <p>Pickup available at <span className="fw-6">Toronto - Spadina Avenue</span> Usually ready in 24 hours</p>
                          <a href="#pickup_available" data-bs-toggle="modal" className>
                      ...
                      <div className="tf-product-bundle-wrap">
                        ...
                        <form className="tf-product-form-bundle">
                          <div className="tf-bundle-products">
                            <div className="tf-bundle-product-item item-has-checkox check mb_15">
                              ...
                              <div className="tf-product-bundle-image">
                                <a href="#">
                                  <img src="/assets/images/shop/products/p-d1.png" alt />
                                </a>
                              </div>
                              <div className="tf-product-bundle-infos">
                                <span className="tf-product-bundle-title"><strong>This item:</strong> Cotton jersey top</span>
                            ...
                            <div className="tf-bundle-product-item item-has-checkox check mb_15">
                              ...
                              <div className="tf-product-bundle-infos">
                                <a href="#" className="tf-product-bundle-title">Oversized Motif T-shirt</a>
                                <div className="tf-product-bundle-price">
                            ...
                            <div className="tf-bundle-product-item item-has-checkox check">
                              ...
                              <div className="tf-product-bundle-infos">
                                <a href="#" className="tf-product-bundle-title">Oversized Printed T-shirt</a>
                                <div className="tf-product-bundle-variant position-relative">
                                  <select className="tf-select">
                                    <option selected="selected">Beige / S</option>
                                    <option>Beige / M</option>
                          ...
                          <a href="#" className="tf-btn w-100 radius-3 justify-content-center btn-primary animate-hover-btn">Add selected to cart</a>
                        </form>
                      </div>
      ...
      <div className="modal modalCentered fade modalDemo tf-product-modal modal-part-content" id="pickup_available">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="header">
              <div className="demo-title">Pickup available</div>
              <span className="icon-close icon-close-popup" data-bs-dismiss="modal" />
            </div>
            <div className="overflow-y-auto">
              <ul className="tf-pickup-availability-list">
                <li className="tf-pickup-availability-item">
                  <div className="tf-pickup-availability-location">Toronto - Spadina Avenue</div>
                  <div className="tf-pickup-availability align-items-center">
                    <div>
                      <svg width={18} height={18} viewBox="0 0 18 18" className>
                        <path d="M7.6 13.2L14.65 6.15L13.25 4.75L7.6 10.4L4.75 7.55L3.35 8.95L7.6 13.2ZM0 18V0H18V18H0ZM2 16H16V2H2V16Z" fill="#428445" />
                      </svg>
                    </div>
                    <div>
                  ...
                  <a href="https://maps.google.com/?daddr=%20Ontario%20Canada" className="tf-btn fw-6 btn-line">Check in google map<i className="icon icon-arrow1-top-left" /></a>
                </li>
                <li className="tf-pickup-availability-item">
                  <div className="tf-pickup-availability-location">Toronto - Adelaide Street</div>
                  <div className="tf-pickup-availability align-items-center">
                    <div>
                      <svg width={18} height={18} viewBox="0 0 18 18" className>
                        <path d="M7.6 13.2L14.65 6.15L13.25 4.75L7.6 10.4L4.75 7.55L3.35 8.95L7.6 13.2ZM0 18V0H18V18H0ZM2 16H16V2H2V16Z" fill="#428445" />
                  ...
                  <a href="https://maps.google.com/?daddr=250%20Adelaide%20Street%20West%20Ontario%20Canada" className="tf-btn fw-6 btn-line">Check in google map<i className="icon icon-arrow1-top-left" /></a>
                </li>
                <li className="tf-pickup-availability-item">
                  <div className="tf-pickup-availability-location">Toronto - King Street</div>
                  <div className="tf-pickup-availability align-items-center">
                    <div>
                      <svg width={18} height={18} viewBox="0 0 18 18" className>
                        <path d="M7.6 13.2L14.65 6.15L13.25 4.75L7.6 10.4L4.75 7.55L3.35 8.95L7.6 13.2ZM0 18V0H18V18H0ZM2 16H16V2H2V16Z" fill="#428445" />
