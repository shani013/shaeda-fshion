                      ...
                      <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                        <div className="swiper-wrapper stagger-wrap">
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/kid-14.jpg" src="/assets/images/products/kid-14.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/kid-11.jpg" src="/assets/images/products/kid-11.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/kid-2.jpg" src="/assets/images/products/kid-2.jpg" alt="img-product" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <a href="images/products/kid-14.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/kid-14.jpg" data-src="/assets/images/products/kid-14.jpg" src="/assets/images/products/kid-14.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/kid-11.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/kid-11.jpg" data-src="/assets/images/products/kid-11.jpg" src="/assets/images/products/kid-11.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/kid-2.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/kid-2.jpg" data-src="/assets/images/products/kid-2.jpg" src="/assets/images/products/kid-2.jpg" alt />
                            </a>
                          </div>
                        </div>
                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-price">
                        <div className="price-on-sale">$130.00</div>
                        <div className="compare-at-price">$170.00</div>
                        <div className="badges-on-sale"><span>24</span>% OFF</div>
                      </div>
                        ...
                        <div className="variant-picker-item">
                          <div className="d-flex justify-content-between align-items-center">
                            <div className="variant-picker-label">
                              Size: <span className="fw-6 variant-picker-label-value">74 cm</span>
                            </div>
                            <a href="#find_size" data-bs-toggle="modal" className="find-size fw-6">Find your size</a>
                          </div>
                          <div className="variant-picker-values">
                            <input type="radio" name="size1" id="values-1" defaultChecked />
                            <label className="style-text" htmlFor="values-1" data-value="74 cm">
                              <p>74 cm</p>
                            </label>
                            <input type="radio" name="size1" id="values-2" />
                            <label className="style-text" htmlFor="values-2" data-value="80 cm">
                              <p>80 cm</p>
                            </label>
                            <input type="radio" name="size1" id="values-3" />
                            <label className="style-text" htmlFor="values-3" data-value="86 cm">
                              <p>86 cm</p>
                            </label>
                            <input type="radio" name="size1" id="values-4" />
                            <label className="style-text" htmlFor="values-4" data-value="98 cm">
                              <p>98 cm</p>
                            </label>
                          </div>
                        </div>
