                      ...
                      <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                        <div className="swiper-wrapper stagger-wrap">
                          ...
                          <div className="swiper-slide stagger-item" data-color="blue">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/light-blue-2.jpg" src="/assets/images/products/light-blue-2.jpg" alt="img-product" />
                            </div>
                          </div>
                          {/* Black */}
                          <div className="swiper-slide stagger-item" data-color="black">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/black-14.jpg" src="/assets/images/products/black-14.jpg" alt="img-product" />
                            </div>
                          </div>
                          {/* White */}
                          <div className="swiper-slide stagger-item" data-color="white">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/white-10.jpg" src="/assets/images/products/white-10.jpg" alt="img-product" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                        <div className="swiper-wrapper">
                          ...
                          <div className="swiper-slide" data-color="blue">
                            <a href="images/products/light-blue-2.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/light-blue-2.jpg" data-src="/assets/images/products/light-blue-2.jpg" src="/assets/images/products/light-blue-2.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* Black */}
                          <div className="swiper-slide" data-color="black">
                            <a href="images/products/black-14.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/black-14.jpg" data-src="/assets/images/products/black-14.jpg" src="/assets/images/products/black-14.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* White */}
                          <div className="swiper-slide" data-color="white">
                            <a href="images/products/white-10.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/white-10.jpg" data-src="/assets/images/products/white-10.jpg" src="/assets/images/products/white-10.jpg" alt="img-product" />
                            </a>
                          </div>
                        </div>
                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          <div className="variant-picker-label">
                            Color: <span className="fw-6 variant-picker-label-value">Blue</span>
                          </div>
                          <div className="variant-picker-values">
                            <input id="values-light-blue" type="radio" name="color1" defaultChecked />
                            <label className="hover-tooltip radius-60 sold-out-line color-btn" data-color="blue" htmlFor="values-light-blue" data-value="Blue">
                              <span className="btn-checkbox bg_light-blue" />
                      ...
                      <div className="tf-product-info-buy-button">
                        <form className>
                          <a href="javascript:void(0);" className="tf-btn btns-sold-out cursor-not-allowed btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn "><span>Sold out -&nbsp;</span><span className="tf-qty-price">$8.00</span></a>
                          ...
                          <div className="w-100">
                            <a href="javascript:void(0);" className="btns-full btns-sold-out cursor-auto btns-sold-out">Buy with <img src="/assets/images/payments/paypal.png" alt /></a>
                      ...
                      <div className="tf-product-notify-stock">
                        <form>
                          ...
                          <button type="submit" className="tf-btn w-100 justify-content-center btn-fill animate-hover-btn flex-shrink-0">Notify me when available</button>
                        </form>
                      </div>
                ...
                <div className="tf-sticky-atc-infos">
                  <form className>
                    ...
                    <div className="tf-sticky-atc-btns">
                      ...
                      <a href="javascript:void(0);" className="tf-btn btns-sold-out cursor-not-allowed btn-fill radius-3 justify-content-center fw-6 fs-14 flex-grow-1 animate-hover-btn "><span>Sold out</span></a>
                    </div>
                  </form>
                </div>
              </div>
