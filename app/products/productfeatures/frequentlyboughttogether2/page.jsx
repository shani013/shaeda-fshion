        ...
        <section className="flat-spacing-4 pt_0">
          ...
          <div className="container">
            <div className="tf-product-fbt-wrap">
              ...
              <form className="tf-product-form-fbt">
                  ...
                  <div className="overflow-x-auto">
                    <div className="tf-product-fbt-list">
                      ...
                      <div className="tf-product-fbt-plus">
                        <svg className xmlns="http://www.w3.org/2000/svg" width={9} height={9} viewBox="0 0 9 9" fill="currentColor">
                  ...
                  <div className="tf-fbt-swatches">
                    <div className="tf-product-bundle-infos">
                      <div className="tf-bundle-check">
                        <input type="checkbox" defaultChecked="checked" id="fbt-ck-1" />
                        <label htmlFor="fbt-ck-1" className>
                          <i className="icon-check" />
                        </label>
                      </div>
                      <span className="tf-product-bundle-title"><strong>This item:</strong> Ribbed modal T-shirt</span>
                    ...
                    <div className="tf-product-bundle-infos">
                      <div className="tf-bundle-check">
                        <input type="checkbox" defaultChecked="checked" id="fbt-ck-2" />
                        <label htmlFor="fbt-ck-2" className>
                          <i className="icon-check" />
                        </label>
                      </div>
                      <a href="#" className="tf-product-bundle-title">Ribbed Tank Top</a>
                      <div className="tf-product-bundle-variant position-relative">
                        <select className="tf-select">
                          <option selected="selected">Beige / S</option>
                          <option>Beige / M</option>
                    ...
                    <div className="tf-product-bundle-infos">
                      <div className="tf-bundle-check">
                        <input type="checkbox" defaultChecked="checked" id="fbt-ck-3" />
                    ...
                    <div className="tf-product-bundle-infos">
                      <div className="tf-bundle-check">
                        <input type="checkbox" defaultChecked="checked" id="fbt-ck-4" />
