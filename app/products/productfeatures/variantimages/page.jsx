...
export default function page() {
  return (
    <div>
      ...
      <div id="wrapper">
                      ...
                      <div className="sub-menu mega-menu">
                        <div className="container">
                          ...
                          <div className="text-center view-all-demo">
                            <a href="#modalDemo" data-bs-toggle="modal" className="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"><span>View all demos (46+)</span><i className="icon icon-arrow-right" /></a>
                          </div>
                        </div>
                      </div>
                    </li>
                              ...
                              <div className="collection-item hover-img">
                                <div className="collection-inner">
                                  <a href="shop-men.html" className="collection-image img-style">
                                    <img className="lazyload" data-src="/assets/images/collections/collection-1.jpg" src="/assets/images/collections/collection-1.jpg" alt="collection-demo-1" />
                                  </a>
                              ...
                              <div className="collection-item hover-img">
                                <div className="collection-inner">
                                  <a href="shop-women.html" className="collection-image img-style">
                                    <img className="lazyload" data-src="/assets/images/collections/collection-2.jpg" src="/assets/images/collections/collection-2.jpg" alt="collection-demo-1" />
                                  </a>
                                  <div className="collection-content">
                            ...
                            <div className="col-lg-2">
                              <div className="mega-menu-item">
                                ...
                                <ul className="menu-list">
                                  ...
                                  <li><a href="product-detail-volume-discount.html" className="menu-link-text link position-relative">Volume Discount<div className="demo-label"><span className="demo-new">New</span></div></a></li>
                                  <li><a href="product-detail-volume-discount-grid.html" className="menu-link-text link position-relative">Volume Discount Grid<div className="demo-label"><span className="demo-new">New</span></div></a></li>
                                  <li><a href="product-detail-buyx-gety.html" className="menu-link-text link position-relative">Buy X Get Y<div className="demo-label"><span className="demo-new">New</span></div></a></li>
                                </ul>
                              </div>
                            </div>
        ...
        <section className="flat-spacing-4 pt_0">
          <div className="tf-main-product section-image-zoom">
            <div className="container widget-tabs">
              <div className="row filter-images-group">
                <div className="col-md-6">
                  <div className="tf-product-media-wrap sticky-top">
                    <div className="tab-content">
                      <div className="tab-pane active show" id="swBeigge" role="tabpanel">
                        <div className="thumbs-slider1 thumbs-default">
                          <div dir="ltr" className="swiper tf-product-media-thumbs tf-product-media-thumbs-default other-image-zoom" data-direction="vertical">
                            <div className="swiper-wrapper stagger-wrap wrap-images-group-item">
                              {/* beige color */}
                              <div className="swiper-slide stagger-item images-group-item beige">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/p-d1.png" src="/assets/images/shop/products/p-d1.png" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item beige">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod.jpg" src="/assets/images/shop/products/hmgoepprod.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item beige">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod2.jpg" src="/assets/images/shop/products/hmgoepprod2.jpg" alt="img-compare" />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item beige">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod3.jpg" src="/assets/images/shop/products/hmgoepprod3.jpg" alt="img-compare" />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item beige">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod4.jpg" src="/assets/images/shop/products/hmgoepprod4.jpg" alt="img-compare" />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item beige">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod5.jpg" src="/assets/images/shop/products/hmgoepprod5.jpg" alt="img-compare" />
                                </div>
                              </div>
                            </div>
                          </div>
                          <div dir="ltr" className="swiper tf-product-media-main tf-product-media-main-default" id="gallery-swiper-started1">
                            <div className="swiper-wrapper">
                              {/* beige */}
                              <div className="swiper-slide images-group-item beige">
                                <a href="images/shop/products/hmgoepprod31.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod31.jpg" data-src="/assets/images/shop/products/hmgoepprod31.jpg" src="/assets/images/shop/products/hmgoepprod31.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item beige">
                                <a href="images/shop/products/hmgoepprod.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod.jpg" data-src="/assets/images/shop/products/hmgoepprod.jpg" src="/assets/images/shop/products/hmgoepprod.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item beige">
                                <a href="images/shop/products/hmgoepprod2.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod2.jpg" data-src="/assets/images/shop/products/hmgoepprod2.jpg" src="/assets/images/shop/products/hmgoepprod2.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item beige">
                                <a href="images/shop/products/hmgoepprod3.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod3.jpg" data-src="/assets/images/shop/products/hmgoepprod3.jpg" src="/assets/images/shop/products/hmgoepprod3.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item beige">
                                <a href="images/shop/products/hmgoepprod4.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod4.jpg" data-src="/assets/images/shop/products/hmgoepprod4.jpg" src="/assets/images/shop/products/hmgoepprod4.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item beige">
                                <a href="images/shop/products/hmgoepprod5.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod5.jpg" data-src="/assets/images/shop/products/hmgoepprod5.jpg" src="/assets/images/shop/products/hmgoepprod5.jpg" alt />
                                </a>
                              </div>
                            </div>
                      ...
                      <div className="tab-pane" id="swBlack" role="tabpanel">
                        <div className="thumbs-slider2 thumbs-slider-black">
                          <div dir="ltr" className="swiper tf-product-media-thumbs tf-product-media-thumbs-black other-image-zoom" data-direction="vertical">
                            <div className="swiper-wrapper stagger-wrap wrap-images-group-item">
                              {/* black color */}
                              <div className="swiper-slide stagger-item images-group-item black">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod6.jpg" src="/assets/images/shop/products/hmgoepprod6.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item black">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod7.jpg" src="/assets/images/shop/products/hmgoepprod7.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item black">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod8.jpg" src="/assets/images/shop/products/hmgoepprod8.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item black">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod9.jpg" src="/assets/images/shop/products/hmgoepprod9.jpg" alt />
                                </div>
                              </div>
                            </div>
                          </div>
                          <div dir="ltr" className="swiper tf-product-media-main tf-product-media-main-black" id="gallery-swiper-started2">
                            <div className="swiper-wrapper">
                              {/* black */}
                              <div className="swiper-slide images-group-item black">
                                <a href="images/shop/products/hmgoepprod6.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod6.jpg" data-src="/assets/images/shop/products/hmgoepprod6.jpg" src="/assets/images/shop/products/hmgoepprod6.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item black">
                                <a href="images/shop/products/hmgoepprod7.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod7.jpg" data-src="/assets/images/shop/products/hmgoepprod7.jpg" src="/assets/images/shop/products/hmgoepprod7.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item black">
                                <a href="images/shop/products/hmgoepprod8.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod8.jpg" data-src="/assets/images/shop/products/hmgoepprod8.jpg" src="/assets/images/shop/products/hmgoepprod8.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item black">
                                <a href="images/shop/products/hmgoepprod9.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod9.jpg" data-src="/assets/images/shop/products/hmgoepprod9.jpg" src="/assets/images/shop/products/hmgoepprod9.jpg" alt />
                                </a>
                              </div>
                            </div>
                            <div className="swiper-button-next button-style-arrow thumbs-next-black" />
                            <div className="swiper-button-prev button-style-arrow thumbs-prev-black" />
                          </div>
                        </div>
                      </div>
                      <div className="tab-pane" id="swBlue" role="tabpanel">
                        <div className="thumbs-slider3 thumbs-slider-blue">
                          <div dir="ltr" className="swiper tf-product-media-thumbs tf-product-media-thumbs-blue other-image-zoom" data-direction="vertical">
                            <div className="swiper-wrapper stagger-wrap wrap-images-group-item">
                              {/* blue */}
                              <div className="swiper-slide stagger-item images-group-item blue">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod10.jpg" src="/assets/images/shop/products/hmgoepprod10.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item blue">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod11.jpg" src="/assets/images/shop/products/hmgoepprod11.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item blue">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod12.jpg" src="/assets/images/shop/products/hmgoepprod12.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item blue">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod13.jpg" src="/assets/images/shop/products/hmgoepprod13.jpg" alt />
                                </div>
                              </div>
                            </div>
                          </div>
                          <div dir="ltr" className="swiper tf-product-media-main tf-product-media-main-blue" id="gallery-swiper-started3">
                            <div className="swiper-wrapper">
                              {/* blue */}
                              <div className="swiper-slide images-group-item blue">
                                <a href="images/shop/products/hmgoepprod10.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod10.jpg" data-src="/assets/images/shop/products/hmgoepprod10.jpg" src="/assets/images/shop/products/hmgoepprod10.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item blue">
                                <a href="images/shop/products/hmgoepprod11.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod11.jpg" data-src="/assets/images/shop/products/hmgoepprod11.jpg" src="/assets/images/shop/products/hmgoepprod11.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item blue">
                                <a href="images/shop/products/hmgoepprod13.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod13.jpg" data-src="/assets/images/shop/products/hmgoepprod13.jpg" src="/assets/images/shop/products/hmgoepprod13.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item blue">
                                <a href="images/shop/products/hmgoepprod13.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            ...
                            <div className="swiper-button-next button-style-arrow thumbs-next-blue" />
                            <div className="swiper-button-prev button-style-arrow thumbs-prev-blue" />
                          </div>
                        </div>
                      </div>
                      <div className="tab-pane" id="swWhite" role="tabpanel">
                        <div className="thumbs-slider4 thumbs-slider-white">
                          <div dir="ltr" className="swiper tf-product-media-thumbs tf-product-media-thumbs-white other-image-zoom" data-direction="vertical">
                            <div className="swiper-wrapper stagger-wrap wrap-images-group-item"> 
                              {/* white */}
                              <div className="swiper-slide stagger-item images-group-item white">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod14.jpg" src="/assets/images/shop/products/hmgoepprod14.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item white">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod15.jpg" src="/assets/images/shop/products/hmgoepprod15.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item white">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod16.jpg" src="/assets/images/shop/products/hmgoepprod16.jpg" alt />
                                </div>
                              </div>
                              <div className="swiper-slide stagger-item images-group-item white">
                                <div className="item">
                                  <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod17.jpg" src="/assets/images/shop/products/hmgoepprod17.jpg" alt />
                                </div>
                              </div>
                            </div>
                          </div>
                          <div dir="ltr" className="swiper tf-product-media-main tf-product-media-main-white" id="gallery-swiper-started4">
                            <div className="swiper-wrapper">
                              <div className="swiper-slide images-group-item white">
                                <a href="images/shop/products/hmgoepprod14.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod14.jpg" data-src="/assets/images/shop/products/hmgoepprod14.jpg" src="/assets/images/shop/products/hmgoepprod14.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item white">
                                <a href="images/shop/products/hmgoepprod15.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod15.jpg" data-src="/assets/images/shop/products/hmgoepprod15.jpg" src="/assets/images/shop/products/hmgoepprod15.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item white">
                                <a href="images/shop/products/hmgoepprod16.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod16.jpg" data-src="/assets/images/shop/products/hmgoepprod16.jpg" src="/assets/images/shop/products/hmgoepprod16.jpg" alt />
                                </a>
                              </div>
                              <div className="swiper-slide images-group-item white">
                                <a href="images/shop/products/hmgoepprod17.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                                  <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod17.jpg" data-src="/assets/images/shop/products/hmgoepprod17.jpg" src="/assets/images/shop/products/hmgoepprod17.jpg" alt />
                                </a>
                              </div>
                            </div>
                            <div className="swiper-button-next button-style-arrow thumbs-next-white" />
                            <div className="swiper-button-prev button-style-arrow thumbs-prev-white" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values wrap-images-group-btn" role="tablist">
                            <input id="values-beige" type="radio" name="color1" defaultChecked />
                            <label className="hover-tooltip radius-60 images-group-btn images-group-btn-first active" data-bs-target="#swBeigge" data-bs-toggle="tab" data-images-group="beige" htmlFor="values-beige" data-color="beige">
                              <span className="btn-checkbox bg-color-beige" />
                              <span className="tooltip">Beige</span>
                            </label>
                            <input id="values-black" type="radio" name="color1" />
                            <label className=" hover-tooltip radius-60 images-group-btn" data-bs-toggle="tab" data-bs-target="#swBlack" data-images-group="black" htmlFor="values-black" data-color="black">
                              <span className="btn-checkbox bg-color-black" />
                              <span className="tooltip">Black</span>
                            </label>
                            <input id="values-blue" type="radio" name="color1" />
                            <label className="hover-tooltip radius-60 images-group-btn" data-bs-toggle="tab" data-bs-target="#swBlue" data-images-group="blue" htmlFor="values-blue" data-color="blue">
                              <span className="btn-checkbox bg-color-blue" />
                              <span className="tooltip">Blue</span>
                            </label>
                            <input id="values-white" type="radio" name="color1" />
                            <label className="hover-tooltip radius-60 images-group-btn" data-bs-toggle="tab" data-bs-target="#swWhite" data-images-group="white" htmlFor="values-white" data-color="white">
                      ...
                      <div className="tf-product-info-quantity">
                        ...
                        <div className="wg-quantity">
                          ...
                          <input type="text" className="quantity-product" name="number" defaultValue={1} />
                          <span className="btn-quantity btn-increase">+</span>
                        </div>
                      </div>
                      <div className="tf-product-info-buy-button">
                        <form className>
                          <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$8.00</span></a>
                      ...
                      <div className="tf-product-info-extra-link">
                        ...
                        <a href="#delivery_return" data-bs-toggle="modal" className="tf-product-extra-icon">
                          <div className="icon">
                            <svg className="d-inline-block" xmlns="http://www.w3.org/2000/svg" width={22} height={18} viewBox="0 0 22 18" fill="currentColor"><path d="M21.7872 10.4724C21.7872 9.73685 21.5432 9.00864 21.1002 8.4217L18.7221 5.27043C18.2421 4.63481 17.4804 4.25532 16.684 4.25532H14.9787V2.54885C14.9787 1.14111 13.8334 0 12.4255 0H9.95745V1.69779H12.4255C12.8948 1.69779 13.2766 2.07962 13.2766 2.54885V14.5957H8.15145C7.80021 13.6052 6.85421 12.8936 5.74468 12.8936C4.63515 12.8936 3.68915 13.6052 3.33792 14.5957H2.55319C2.08396 14.5957 1.70213 14.2139 1.70213 13.7447V2.54885C1.70213 2.07962 2.08396 1.69779 2.55319 1.69779H9.95745V0H2.55319C1.14528 0 0 1.14111 0 2.54885V13.7447C0 15.1526 1.14528 16.2979 2.55319 16.2979H3.33792C3.68915 17.2884 4.63515 18 5.74468 18C6.85421 18 7.80021 17.2884 8.15145 16.2979H13.423C13.7742 17.2884 14.7202 18 15.8297 18C16.9393 18 17.8853 17.2884 18.2365 16.2979H21.7872V10.4724ZM16.684 5.95745C16.9494 5.95745 17.2034 6.08396 17.3634 6.29574L19.5166 9.14894H14.9787V5.95745H16.684ZM5.74468 16.2979C5.27545 16.2979 4.89362 15.916 4.89362 15.4468C4.89362 14.9776 5.27545 14.5957 5.74468 14.5957C6.21392 14.5957 6.59575 14.9776 6.59575 15.4468C6.59575 15.916 6.21392 16.2979 5.74468 16.2979ZM15.8298 16.2979C15.3606 16.2979 14.9787 15.916 14.9787 15.4468C14.9787 14.9776 15.3606 14.5957 15.8298 14.5957C16.299 14.5957 16.6809 14.9776 16.6809 15.4468C16.6809 15.916 16.299 16.2979 15.8298 16.2979ZM18.2366 14.5957C17.8853 13.6052 16.9393 12.8936 15.8298 12.8936C15.5398 12.8935 15.252 12.943 14.9787 13.04V10.8511H20.0851V14.5957H18.2366Z" /></svg>
                          </div>
              ...
              <div className="tf-height-observer w-100 d-flex align-items-center">
                <div className="tf-sticky-atc-product d-flex align-items-center">
                  <div className="tf-sticky-atc-img">
                    <img className="lazyload" data-src="/assets/images/shop/products/p-d1.png" alt src="/assets/images/shop/products/p-d1.png" />
                  </div>
                ...
                <div className="tf-sticky-atc-infos">
                  <form className>
                    ...
                    <div className="tf-sticky-atc-btns">
                      ...
                      <a href="javascript:void(0);" className="tf-btn btn-fill radius-3 justify-content-center fw-6 fs-14 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart</span></a>
                    </div>
                  </form>
                </div>
              </div>
                ...
                <div className="widget-tabs style-has-border">
                  ...
                  <div className="widget-content-tab">
                    ...
                    <div className="widget-content-inner">
                      <div className="tab-reviews write-cancel-review-wrap">
                        <div className="tab-reviews-heading">
                          ...
                          <div>
                            <div className="tf-btn btn-outline-dark fw-6 btn-comment-review btn-cancel-review">Cancel Review</div>
                            <div className="tf-btn btn-outline-dark fw-6 btn-comment-review btn-write-review">Write a review</div>
                          </div>
                        </div>
                        <div className="reply-comment cancel-review-wrap">
                          ...
                          <div className="reply-comment-wrap">
                            <div className="reply-comment-item">
                              <div className="user">
                                <div className="image">
                                  <img src="/assets/images/collections/collection-circle-9.jpg" alt />
                                </div>
                                <div>
                                  <h6>
                              ...
                              <p className="text_black-2">Great theme - we were looking for a theme with lots of built in features and flexibility and this was perfect. We expected to need to employ a developer to add a few finishing touches. But we actually managed to do everything ourselves. We did have one small query and the support given was swift and helpful.</p>
                            </div>
                            <div className="reply-comment-item type-reply">
                              <div className="user">
                                <div className="image">
                                  <img src="/assets/images/collections/collection-circle-10.jpg" alt />
                                </div>
                                <div>
                                  <h6>
                              ...
                              <p className="text_black-2">We love to hear it! Part of what we love most about Modave is how much it empowers store owners like yourself to build a beautiful website without having to hire a developer :) Thank you for this fantastic review!</p>
                            </div>
                            <div className="reply-comment-item">
                              <div className="user">
                                <div className="image">
                        ...
                        <form className="form-write-review write-review-wrap">
                          ...
                          <div className="form-content">
                            <fieldset className="box-field">
                              ...
                              <input type="text" placeholder="Give your review a title" name="text" tabIndex={2} defaultValue aria-required="true" required />
                            </fieldset>
                            <fieldset className="box-field">
                              <label className="label">Review</label>
                              <textarea rows={4} placeholder="Write your comment here" tabIndex={2} aria-required="true" required defaultValue={""} />
                            </fieldset>
                            <div className="box-field group-2">
                              <fieldset>
                                <input type="text" placeholder="You Name (Public)" name="text" tabIndex={2} defaultValue aria-required="true" required />
                              </fieldset>
                              <fieldset>
                                <input type="email" placeholder="Your email (private)" name="email" tabIndex={2} defaultValue aria-required="true" required />
                              </fieldset>
                            </div>
                            <div className="box-check">
                              <input type="checkbox" name="availability" className="tf-check" id="check1" />
                              <label className="text_black-2" htmlFor="check1">Save my name, email, and website in this browser for the next time I comment.</label>
                            </div>
                          </div>
                    ...
                    <div className="widget-content-inner">
                      ...
                      <p className="text-center text-paragraph">LT01: 70% wool, 15% polyester, 10% polyamide, 5% acrylic 900 Grms/mt</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="flat-spacing-1 pt_0">
          <div className="container">
            ...
            <div className="hover-sw-nav hover-sw-2">
              <div dir="ltr" className="swiper tf-sw-product-sell wrap-sw-over" data-preview={4} data-tablet={3} data-mobile={2} data-space-lg={30} data-space-md={15} data-pagination={2} data-pagination-md={3} data-pagination-lg={3}>
                <div className="swiper-wrapper">
                  <div className="swiper-slide" lazy="true">
                    <div className="card-product">
                      <div className="card-product-wrapper">
        ...
        <section className="flat-spacing-4 pt_0">
          <div className="container">
            ...
            <div className="hover-sw-nav hover-sw-2">
              <div dir="ltr" className="swiper tf-sw-recent wrap-sw-over" data-preview={4} data-tablet={3} data-mobile={2} data-space-lg={30} data-space-md={30} data-space={15} data-pagination={1} data-pagination-md={1} data-pagination-lg={1}>
                <div className="swiper-wrapper">
                  <div className="swiper-slide" lazy="true">
                    <div className="card-product">
                      <div className="card-product-wrapper">
              ...
              <div className="nav-sw nav-next-slider nav-next-recent box-icon w_46 round"><span className="icon icon-arrow-left" /></div>
              <div className="nav-sw nav-prev-slider nav-prev-recent box-icon w_46 round"><span className="icon icon-arrow-right" /></div>
      ...
      <Footer2/>
      {/* modal compare_color */}
      <div className="modal fade modalDemo tf-product-modal modal-part-content" id="compare_color">
              ...
              <div className="tf-compare-color-grid">
                ...
                <div className="tf-compare-color-item">
                  <div className="tf-compare-color-top">
                    <label htmlFor="remove-compare-color-beige-1" className="tf-compare-color-remove">Remove</label>
                    <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod2.jpg" src="/assets/images/shop/products/hmgoepprod2.jpg" alt="img-compare" />
                  </div>
                  <div className="tf-compare-color-bottom">
                    ...
                    <form className>
                      ...
                      <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn btn-add-to-cart"><span>Add to cart</span></a>
                    </form>
                  </div>
                </div>
                ...
                <div className="tf-compare-color-item">
                  <div className="tf-compare-color-top">
                    <label htmlFor="remove-compare-color-beige-2" className="tf-compare-color-remove">Remove</label>
                    <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod12.jpg" src="/assets/images/shop/products/hmgoepprod12.jpg" alt />
                  </div>
                  <div className="tf-compare-color-bottom">
                    <div className="tf-compare-color-color">
                ...
                <div className="tf-compare-color-item">
                  <div className="tf-compare-color-top">
                    <label htmlFor="remove-compare-color-beige-3" className="tf-compare-color-remove">Remove</label>
                    <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod7.jpg" src="/assets/images/shop/products/hmgoepprod7.jpg" alt />
                  </div>
                  <div className="tf-compare-color-bottom">
                    <div className="tf-compare-color-color">
                ...
                <div className="tf-compare-color-item">
                  <div className="tf-compare-color-top">
                    <label htmlFor="remove-compare-color-beige-4" className="tf-compare-color-remove">Remove</label>
                    <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod14.jpg" src="/assets/images/shop/products/hmgoepprod14.jpg" alt />
                  </div>
                  <div className="tf-compare-color-bottom">
                    <div className="tf-compare-color-color">
            ...
            <div className="overflow-y-auto">
              <form className>
                <fieldset className>
                  ...
                  <input type="text" placeholder className name="text" tabIndex={2} defaultValue aria-required="true" required />
                </fieldset>
                <fieldset className>
                  <label htmlFor>Email *</label>
                  <input type="email" placeholder className name="text" tabIndex={2} defaultValue aria-required="true" required />
                </fieldset>
                <fieldset className>
                  <label htmlFor>Phone number</label>
                  <input type="number" placeholder className name="text" tabIndex={2} defaultValue aria-required="true" required />
                </fieldset>
                <fieldset className>
                  <label htmlFor>Message</label>
                  <textarea name="message" rows={4} placeholder className tabIndex={2} aria-required="true" required defaultValue={""} />
                </fieldset>
                <button type="submit" className="tf-btn w-100 btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn"><span>Send</span></button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div className="modal-content">
            ...
            <div className="overflow-y-auto">
              ...
              <div className="tf-product-popup-delivery">
                ...
                <p className="text-paragraph">Items returned within 14 days of their original shipment date in same
                  as new condition will be eligible for a full refund or store credit.</p>
                <p className="text-paragraph">Refunds will be charged back to the original form of payment used for
                  purchase.</p>
                <p className="text-paragraph">Customer is responsible for shipping charges when making returns and
              ...
              <div className="tf-product-popup-delivery">
                ...
                <p className="text-paragraph">Email: <a href="mailto:contact@domain.com" aria-describedby="a11y-external-message"><span className="__cf_email__">contact@domain.com</span></a></p>
          ...
          <div className="modal-content">
            ...
            <div className="overflow-y-auto">
              <ul className="tf-social-icon d-flex gap-10">
                ...
                <li><a href="#" className="box-icon social-twiter bg_line"><i className="icon icon-Icon-x" /></a></li>
                ...
                <li><a href="#" className="box-icon social-pinterest bg_line"><i className="icon icon-pinterest-1" /></a></li>
              </ul>
              <form className="form-share" method="post" acceptCharset="utf-8">
                <fieldset>
                  <input type="text" defaultValue="https://themesflat.co/html/ecomus/" tabIndex={0} aria-required="true" />
                </fieldset>
                <div className="button-submit">
      ...
      <div className="modal fullRight fade modal-shopping-cart" id="shoppingCart">
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="header">
              <div className="title fw-5">Shopping cart <span>(2)</span></div>
              <span className="icon-close icon-close-popup" data-bs-dismiss="modal" />
            </div>
            <div className="wrap">
