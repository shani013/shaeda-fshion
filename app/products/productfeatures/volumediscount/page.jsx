          ...
          <div className="container">
            <div className="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
              <div className="tf-breadcrumb-list">
                ...
                <span className="text">Emerald Pool - Elegant iPhone case</span>
              </div>
                      ...
                      <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                        <div className="swiper-wrapper stagger-wrap">
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/phone-detail1.jpg" src="/assets/images/products/phone-detail1.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/phone-detail2.jpg" src="/assets/images/products/phone-detail2.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/phone-detail3.jpg" src="/assets/images/products/phone-detail3.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/phone-detail4.jpg" src="/assets/images/products/phone-detail4.jpg" alt="img-product" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <a href="images/products/phone-detail1.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/phone-detail1.jpg" data-src="/assets/images/products/phone-detail1.jpg" src="/assets/images/products/phone-detail1.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/phone-detail2.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/phone-detail2.jpg" data-src="/assets/images/products/phone-detail1.jpg" src="/assets/images/products/phone-detail2.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/phone-detail3.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/phone-detail3.jpg" data-src="/assets/images/products/phone-detail3.jpg" src="/assets/images/products/phone-detail3.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/phone-detail4.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/phone-detail4.jpg" data-src="/assets/images/products/phone-detail4.jpg" src="/assets/images/products/phone-detail4.jpg" alt />
                            </a>
                          </div>
                        </div>
                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      <div className="tf-product-info-title">
                        <h5>Emerald Pool - Elegant iPhone case</h5>
                      </div>
                      <div className="tf-product-info-price">
                        <div className="price-on-sale text_black">$30.00</div>
                      </div>
                      ...
                      <div className="tf-product-info-quantity">
                        <div className="quantity-title fw-6">Quantity (23 in cart)</div>
                      ...
                      <div className="tf-product-info-buy-button">
                        <form className>
                          <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$30.00</span></a>
                          ...
                          <div className="w-100">
                            <a href="checkout.html" className="tf-btn btn-primary justify-content-center w-100 animate-hover-btn">BUY IT NOW</a>
                          </div>
                        </form>
                      </div>
                      <div className="tf-product-volume-discount">
                        <div className="flat-check-list list-volume-discount">
                          <div className="check-item volume-discount-item active">
                            <div className="rule-item-summary">
                              <div className="check-radio"><span /></div>
                              <h5 className="name">Buy 3 items for 10% OFF per item</h5>
                              <span className="percent">Save 10%</span>
                            </div>
                            <div className="d-flex justify-content-end">
                              <div className="rule-price-total">
                                <div className="price-label">Total</div>
                                <div className="price-compare">$90.00</div>
                                <div className="price-regular">$81.00</div>
                              </div>
                            </div>
                          </div>
                          <div className="check-item volume-discount-item">
                            <div className="rule-item-summary">
                              <div className="check-radio"><span /></div>
                              <h5 className="name">Buy 5 items for 15% OFF per item</h5>
                              <span className="percent">Save 15%</span>
                            </div>
                            <div className="d-flex justify-content-end">
                              <div className="rule-price-total">
                                <div className="price-label">Total</div>
                                <div className="price-compare">$150.00</div>
                                <div className="price-regular">$127.00</div>
                              </div>
                            </div>
                          </div>
                          <div className="check-item volume-discount-item">
                            <div className="rule-item-summary">
                              <div className="check-radio"><span /></div>
                              <h5 className="name">Buy 7 items for 20% OFF per item</h5>
                              <span className="percent">Save 20%</span>
                            </div>
                            <div className="d-flex justify-content-end">
                              <div className="rule-price-total">
                                <div className="price-label">Total</div>
                                <div className="price-compare">$210.00</div>
                                <div className="price-regular">$168.00</div>
                              </div>
                            </div>
                          </div>
                          <div className="check-item volume-discount-item">
                            <div className="rule-item-summary">
                              <div className="check-radio"><span /></div>
                              <h5 className="name">Buy 9 items for 25% OFF per item</h5>
                              <span className="percent">Save 25%</span>
                            </div>
                            <div className="d-flex justify-content-end">
                              <div className="rule-price-total">
                                <div className="price-label">Total</div>
                                <div className="price-compare">$270.00</div>
                                <div className="price-regular">$200.00</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        <button className="tf-btn btn-fill w-100 justify-content-center fw-6 fs-16 animate-hover-btn btn-add-to-cart">Choose this deal</button>
                      </div>
              ...
              <div className="tf-height-observer w-100 d-flex align-items-center">
                <div className="tf-sticky-atc-product d-flex align-items-center">
                  <div className="tf-sticky-atc-img">
                    <img className="lazyloaded" data-src="/assets/images/products/phone-detail1.jpg" alt src="/assets/images/products/phone-detail1.jpg" />
                  </div>
                  <div className="tf-sticky-atc-title fw-5 d-xl-block d-none">Emerald Pool - Elegant iPhone case</div>
                </div>
              ...
              <div className="tf-mini-cart-wrap">
                ...
                <div className="tf-mini-cart-bottom">
                  ...
                  <div className="tf-mini-cart-bottom-wrap">
                    <div className="tf-cart-totals-volume-discounts">
                      <div className="cart-volume-discount">
                        ...
                        <strong className="discount-amount">(- $195.00)</strong>
                      </div>
                      <div className="cart-volume-discount">
                        <span className="discount-title">
                          <svg xmlns="http://www.w3.org/2000/svg" height={16} width={16} viewBox="0 0 512 512"><path d="M497.9 225.9L286.1 14.1A48 48 0 0 0 252.1 0H48C21.5 0 0 21.5 0 48v204.1a48 48 0 0 0 14.1 33.9l211.9 211.9c18.7 18.7 49.1 18.7 67.9 0l204.1-204.1c18.7-18.7 18.7-49.1 0-67.9zm-22.6 45.3L271.2 475.3c-6.2 6.2-16.4 6.3-22.6 0L36.7 263.4A15.9 15.9 0 0 1 32 252.1V48c0-8.8 7.2-16 16-16h204.1c4.3 0 8.3 1.7 11.3 4.7l211.9 211.9c6.2 6.2 6.2 16.4 0 22.6zM144 124c11 0 20 9 20 20s-9 20-20 20-20-9-20-20 9-20 20-20m0-28c-26.5 0-48 21.5-48 48s21.5 48 48 48 48-21.5 48-48-21.5-48-48-48z" /></svg>
                          <span>Volume discount 3</span>
                        </span>
                        <strong className="discount-amount">(- $54.60)</strong>
                      </div>
                    </div>
