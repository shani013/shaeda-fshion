          ...
          <div className="container">
            <div className="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
              <div className="tf-breadcrumb-list">
                ...
                <span className="text">Skarpetki Planets</span>
              </div>
                      ...
                      <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                        <div className="swiper-wrapper stagger-wrap">
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/sock3.jpg" src="/assets/images/products/sock3.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/sock4.jpg" src="/assets/images/products/sock4.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/sock6.jpg" src="/assets/images/products/sock6.jpg" alt="img-product" />
                            </div>
                          </div>                                            
                        </div>
                      </div>
                      <div dir="ltr" className="swiper tf-product-media-main rounded-0" id="gallery-swiper-started">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <a href="images/products/sock3.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/sock3.jpg" data-src="/assets/images/products/sock3.jpg" src="/assets/images/products/sock3.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/sock4.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/sock4.jpg" data-src="/assets/images/products/sock4.jpg" src="/assets/images/products/sock4.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/sock6.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/sock6.jpg" data-src="/assets/images/products/sock6.jpg" src="/assets/images/products/sock6.jpg" alt />
                            </a>
                          </div>                                            
                        </div>
                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-quantity">
                        <div className="quantity-title fw-6">Quantity (10 in cart)</div>
                        ...
                        <div className="flat-check-list list-volume-discount-grid">
                            ...
                            <div className="rule-item-summary">
                              ...
                              <div className="thumbnail-box">
                                <div className="thumbnail">
                                  <img src="/assets/images/item/sock-3items.jpg" alt="img" />
                                </div>
                                <h5 className="name">3x Socks</h5>
                              </div>
                          ...
                          <div className="check-item volume-discount-item">
                            <div className="rule-item-summary">
                              ...
                              <div className="thumbnail-box">
                                <div className="thumbnail">
                                  <img src="/assets/images/item/sock-5items.jpg" alt="img" />
                                </div>
                                <h5 className="name">5x Socks</h5>
                              </div>
                              <span className="percent">Save 15%</span>
                            </div>
                            <div className="rule-price-total">
                              <div className="price-compare">$195.00</div>
                              <div className="price-regular">$165.75</div>
                            </div>
                          ...
                          <div className="check-item volume-discount-item">
                            <div className="rule-item-summary">
                              ...
                              <div className="thumbnail-box">
                                ...
                                <h5 className="name">7x Socks</h5>
                              </div>
                              <span className="percent">Save 20%</span>
                            </div>
                            <div className="rule-price-total">
                              <div className="price-compare">$273.00</div>
                              <div className="price-regular">$218.40</div>
                            </div>
                          </div>
                        </div>
                        <button className="tf-btn bg_green-11 w-100 justify-content-center fw-6 effect-flash text_white text-uppercase letter-3 btn-add-to-cart">Choose this deal</button>
                      </div>
              ...
              <div className="tf-height-observer w-100 d-flex align-items-center">
                <div className="tf-sticky-atc-product d-flex align-items-center">
                  <div className="tf-sticky-atc-img">
                    <img className="lazyloaded" data-src="/assets/images/products/sock3.jpg" alt src="/assets/images/products/sock3.jpg" />
                  </div>
                  <div className="tf-sticky-atc-title fw-5 d-xl-block d-none">Skarpetki Planets</div>
                </div>
                <div className="tf-sticky-atc-infos">
                  <form className>
                    <div className="tf-sticky-atc-variant-price text-center">
                      <span className="price fs-16">$39.00</span> 
                    </div>
