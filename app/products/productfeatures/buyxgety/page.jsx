                      ...
                      <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                        <div className="swiper-wrapper stagger-wrap">
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/gaming-detail1.jpg" src="/assets/images/products/gaming-detail1.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/gaming-detail2.jpg" src="/assets/images/products/gaming-detail2.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/gaming-detail3.jpg" src="/assets/images/products/gaming-detail3.jpg" alt="img-product" />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/gaming-detail4.jpg" src="/assets/images/products/gaming-detail4.jpg" alt="img-product" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <a href="images/products/gaming-detail1.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/gaming-detail1.jpg" data-src="/assets/images/products/gaming-detail1.jpg" src="/assets/images/products/gaming-detail1.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/gaming-detail2.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/gaming-detail2.jpg" data-src="/assets/images/products/gaming-detail2.jpg" src="/assets/images/products/gaming-detail2.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/gaming-detail3.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/gaming-detail3.jpg" data-src="/assets/images/products/gaming-detail3.jpg" src="/assets/images/products/gaming-detail3.jpg" alt />
                            </a>
                          </div>
                          <div className="swiper-slide">
                            <a href="images/products/gaming-detail4.jpg" target="_blank" className="item" data-pswp-width="606px" data-pswp-height="606px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/gaming-detail4.jpg" data-src="/assets/images/products/gaming-detail4.jpg" src="/assets/images/products/gaming-detail4.jpg" alt />
                            </a>
                          </div>
                        </div>
                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-price">
                        <div className="price-on-sale text_black">$39.00</div>
                      </div>
                      ...
                      <div className="tf-product-info-buy-button">
                        <form className>
                          <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$39.00</span></a>
                      ...
                      <div className="tf-product-buyx-gety">
                        ...
                        <div className="buyx-gety-content">
                            ...
                            <div className="buyx-gety-item-inner">
                              <div className="pr-item-info">
                                <div className="thumbnails">
                                  <img src="/assets/images/products/gaming-detail1.jpg" alt />
                                </div>
                                <div className="content">
                                  <a href="product-detail.html" className="name fs-16 link fw-5">DualSens Game Controller</a>
                          ...
                          <div className="buyx-gety-item">
                            <div className="buyx-gety-item-inner">
                              <div className="pr-item-info">
                                <div className="thumbnails">
                                  <img src="/assets/images/products/headphone-2.png" alt />
                                </div>
                                <div className="content">
                                  <a href="product-detail.html" className="name fs-16 link fw-5">DualSens Game Controller</a>
                                  <span className="fs-12 qty">Qty: 1</span>
                              ...
                              <div className="pr-item-price-total">
                                <span className="total-label fw-5">Total</span>
                                <span className="price-nomal price-old text_black-2 fw-5">$0.00</span>
                        ...
                        <button className="tf-btn bg_pink-2 w-100 justify-content-center fw-6 effect-flash text_white text-uppercase letter-2 btn-add-to-cart">Grab this deal !</button>
                      </div>
              ...
              <div className="tf-height-observer w-100 d-flex align-items-center">
                <div className="tf-sticky-atc-product d-flex align-items-center">
                  <div className="tf-sticky-atc-img">
                    <img className="lazyloaded" data-src="/assets/images/products/gaming-detail1.jpg" alt src="/assets/images/products/gaming-detail1.jpg" />
                  </div>
                  <div className="tf-sticky-atc-title fw-5 d-xl-block d-none">DualSens Game Controller</div>
                </div>
                <div className="tf-sticky-atc-infos">
                  <form>
                    <div className="tf-sticky-atc-variant-price text-center">
                      <span className="price fs-16">$159.99</span>
                    </div>
