...
export default function page() {
  ...
  return (
    <div>
                        ...
                        <div className="swiper-wrapper stagger-wrap">
                          ...
                          >
                            <div className="item">
                              <img
                                className="lazyload"
                                data-src="/assets/images/shop/products/hmgoepprod4.jpg"
                                src="/assets/images/shop/products/hmgoepprod4.jpg"
                                alt="img-product"
                              />
                            </div>
                          </div>
                          ...
                          >
                            <div className="item">
                              <img
                                className="lazyload"
                                data-src="/assets/images/shop/products/hmgoepprod5.jpg"
                                src="/assets/images/shop/products/hmgoepprod5.jpg"
                                alt="img-product"
                              />
                            </div>
                          </div>
                            ...
                            >
                              <div className="tf-variant-inner">
                                <div className="tf-price-list">
                                  ...
                                  <div className="compare-at-price price">
                                    $8.00
                                  </div>
                                </div>
                              </div>
      ...
      {/* modal ask_question */}
      <div
        className="modal modalNone fade modalDemo tf-product-modal modal-part-content"
        id="ask_question"
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
