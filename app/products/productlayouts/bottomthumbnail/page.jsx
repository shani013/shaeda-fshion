              ...
              <div className="col-md-6">
                <div className="tf-product-media-wrap thumbs-bottom sticky-top">
                  <div className="thumbs-slider">
                    <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                      <div className="swiper-wrapper">
                        ...
                        <div className="swiper-slide" data-color="brown">
                          <a href="images/products/brown-2.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/brown-2.jpg" data-src="/assets/images/products/brown-2.jpg" src="/assets/images/products/brown-2.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="brown">
                          <a href="images/products/brown-3.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/brown-3.jpg" data-src="/assets/images/products/brown-3.jpg" src="/assets/images/products/brown-3.jpg" alt="img-product" />
                          </a>
                        </div>
                        {/* white */}
                        <div className="swiper-slide" data-color="white">
                          <a href="images/products/white-5.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/white-5.jpg" data-src="/assets/images/products/white-5.jpg" src="/assets/images/products/white-5.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="white">
                          <a href="images/products/white-4.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/white-4.jpg" data-src="/assets/images/products/white-4.jpg" src="/assets/images/products/white-4.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="white">
                          <a href="images/products/white-3.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/white-3.jpg" data-src="/assets/images/products/white-3.jpg" src="/assets/images/products/white-3.jpg" alt="img-product" />
                          </a>
                        </div>
                        {/* black */}
                        <div className="swiper-slide" data-color="black">
                          <a href="images/products/black-5.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/black-5.jpg" data-src="/assets/images/products/black-5.jpg" src="/assets/images/products/black-5.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="black">
                          <a href="images/products/black-3.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/black-3.jpg" data-src="/assets/images/products/black-3.jpg" src="/assets/images/products/black-3.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="black">
                          <a href="images/products/black-4.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/black-4.jpg" data-src="/assets/images/products/black-4.jpg" src="/assets/images/products/black-4.jpg" alt="img-product" />
                          </a>
                        </div>
                      </div>
                    ...
                    <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="horizontal">
                      <div className="swiper-wrapper stagger-wrap">
                        {/* brown */}
                        <div className="swiper-slide stagger-item" data-color="brown">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/brown-2.jpg" src="/assets/images/products/brown-2.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="brown">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/brown-3.jpg" src="/assets/images/products/brown-3.jpg" alt="img-product" />
                          </div>
                        </div>
                        {/* white */}
                        <div className="swiper-slide stagger-item" data-color="white">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/white-5.jpg" src="/assets/images/products/white-5.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="white">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/white-4.jpg" src="/assets/images/products/white-4.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="white">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/white-3.jpg" src="/assets/images/products/white-3.jpg" alt="img-product" />
                          </div>
                        </div>
                        {/* black */}
                        <div className="swiper-slide stagger-item" data-color="black">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/black-5.jpg" src="/assets/images/products/black-5.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="black">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/black-3.jpg" src="/assets/images/products/black-3.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="black">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/black-4.jpg" src="/assets/images/products/black-4.jpg" alt="img-product" />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="tf-product-info-wrap position-relative">
                  ...
                  <div className="tf-product-info-list other-image-zoom">
                    ...
                    <div className="tf-product-info-price">
                      <div className="price-on-sale">$122.00</div>
                      <div className="compare-at-price">$150.00</div>
                      <div className="badges-on-sale"><span>19</span>% OFF</div>
                    </div>
                    <div className="tf-product-info-liveview">
                      <div className="liveview-count">22</div>
                      <p className="fw-6">People are viewing this right now</p>
                    </div>
                    <div className="tf-product-info-variant-picker">
                      <div className="variant-picker-item">
                        <div className="variant-picker-label">
                          Color: <span className="fw-6 variant-picker-label-value value-currentColor">Brown</span>
                        </div>
                        <div className="variant-picker-values">
                          <input id="values-brown" type="radio" name="color1" defaultChecked />
                          <label className="hover-tooltip radius-60 color-btn" data-color="brown" htmlFor="values-brown" data-value="Brown">
                            <span className="btn-checkbox bg_brown" />
                            <span className="tooltip">Brown</span>
                          </label>
                          <input id="values-white" type="radio" name="color1" />
                          <label className=" hover-tooltip radius-60 color-btn" data-color="white" htmlFor="values-white" data-value="White">
                            <span className="btn-checkbox bg_white" />
                          ...
                          <label className="hover-tooltip radius-60 color-btn" data-color="black" htmlFor="values-black" data-value="Black">
                            <span className="btn-checkbox bg-dark" />
                    ...
                    <div className="tf-product-info-buy-button">
                      <form className>
                        <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$122.00</span></a>
