        ...
        <div className="container">
          <div className="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
            ...
            <div className="tf-breadcrumb-prev-next">
              <a href="#" className="tf-breadcrumb-prev center">
                <i className="icon icon-arrow-left" />
              </a>
              <a href="#" className="tf-breadcrumb-back center">
                <i className="icon icon-shop" />
              </a>
              <a href="#" className="tf-breadcrumb-next center">
                <i className="icon icon-arrow-right" />
              </a>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="tf-product-media-wrap">
                  <div className="d-flex flex-column gap-10 wrapper-gallery-scroll" id="gallery-started">
                    <a href="images/shop/products/p-d3.png" target="_blank" data-color="brown" className="item item-img-color" data-pswp-width="770px" data-pswp-height="1075px">
                      <img className="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/p-d3.png" data-src="/assets/images/shop/products/p-d3.png" src="/assets/images/shop/products/p-d3.png" alt />
                    </a>
                    <a href="images/shop/products/p-d3-1.jpg" target="_blank" data-color="purple" className="item item-img-color" data-pswp-width="770px" data-pswp-height="1075px">
                      <img className="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/p-d3-1.jpg" data-src="/assets/images/shop/products/p-d3-1.jpg" src="/assets/images/shop/products/p-d3-1.jpg" alt />
                    </a>
                    <a href="images/shop/products/p-d3-2.jpg" target="_blank" data-color="light-green" className="item item-img-color" data-pswp-width="770px" data-pswp-height="1075px">
                      <img className="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/p-d3-2.jpg" data-src="/assets/images/shop/products/p-d3-2.jpg" src="/assets/images/shop/products/p-d3-2.jpg" alt />
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <div className="tf-product-info-list other-image-zoom">
                    ...
                    <div className="tf-product-info-variant-picker">
                      <div className="variant-picker-item">
                        ...
                        <div className="variant-picker-values">
                          ...
                          <label className="hover-tooltip radius-60 color-btn btn-grid-color active" htmlFor="values-brown" data-color="brown" data-value="Brown">
                            <span className="btn-checkbox bg-color-brown" />
                            <span className="tooltip">Brown</span>
                          </label>
                          <input id="values-light-purple" type="radio" name="color1" />
                          <label className="hover-tooltip radius-60 color-btn btn-grid-color" data-price={9} htmlFor="values-light-purple" data-color="purple" data-value="Light Purple">
                          ...
                          <label className="hover-tooltip radius-60 color-btn btn-grid-color" data-price={10} htmlFor="values-light-green" data-color="light-green" data-value="Light Green">
                    ...
                    <div className="tf-product-info-quantity">
                      ...
                      <div className="wg-quantity">
                        ...
                        <input type="text" className="quantity-product" defaultValue={1} />
                    ...
                    <div className="tf-product-info-extra-link">
                      ...
                      <a href="#share_social" className="tf-product-extra-icon">
                        <div className="icon">
