                ...
                <div className>
                  <div className="d-grid grid-template-columns-2 gap-10" id="gallery-started">
                    <a href="images/shop/products/hmgoepprod.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                      <img id="image-color-brown" className="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod.jpg" data-src="/assets/images/shop/products/hmgoepprod.jpg" src="/assets/images/shop/products/hmgoepprod.jpg" alt />
                    </a>
                    <a href="images/shop/products/hmgoepprod2.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                      <img id="image-color-light-purple" className="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod2.jpg" data-src="/assets/images/shop/products/hmgoepprod2.jpg" src="/assets/images/shop/products/hmgoepprod2.jpg" alt />
                    </a>
                    <a href="images/shop/products/hmgoepprod3.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                      <img id="image-color-light-green" className="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod3.jpg" data-src="/assets/images/shop/products/hmgoepprod3.jpg" src="/assets/images/shop/products/hmgoepprod3.jpg" alt />
                    </a>
                    <a href="images/shop/products/hmgoepprod4.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                      <img id="image-color-light-green" className="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod4.jpg" data-src="/assets/images/shop/products/hmgoepprod4.jpg" src="/assets/images/shop/products/hmgoepprod4.jpg" alt />
                    </a>
                    <a href="images/shop/products/hmgoepprod4.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                      <img id="image-color-light-green" className="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod4.jpg" data-src="/assets/images/shop/products/hmgoepprod4.jpg" src="/assets/images/shop/products/hmgoepprod4.jpg" alt />
                    </a>
              ...
              <div className="tf-product-info-wrap sticky-top">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  ...
                  <div className="tf-product-info-price">
                    <div className="price price-on-sale text_black">$12.00</div>
                  </div>
                  ...
                  <div className="tf-product-info-buy-button">
                    <form className>
                      <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$12.00</span></a>
          ...
          <div className="tf-product-info-wrap position-relative">
            <div className="tf-product-info-list">
              ...
              <div className="tf-product-info-variant-picker">
                <div className="variant-picker-item">
                  <div className="variant-picker-label">
                    Color: <span className="fw-6 variant-picker-label-value value-currentColor">Orange</span>
                  </div>
                  <div className="variant-picker-values">
