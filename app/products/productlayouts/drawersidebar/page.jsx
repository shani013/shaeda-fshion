  ...
  return (
    ...
    <div id="wrapper">
                    ...
                    <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                      <div className="swiper-wrapper stagger-wrap">
                        ...
                        <div className="swiper-slide stagger-item" data-color="beige">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod31.jpg" src="/assets/images/shop/products/hmgoepprod31.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="beige">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod.jpg" src="/assets/images/shop/products/hmgoepprod.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="beige">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod2.jpg" src="/assets/images/shop/products/hmgoepprod2.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="beige">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod3.jpg" src="/assets/images/shop/products/hmgoepprod3.jpg" alt="img-product" />
                          </div>
                        </div>
                        {/* black */}
                        <div className="swiper-slide stagger-item" data-color="black">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod6.jpg" src="/assets/images/shop/products/hmgoepprod6.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="black">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod7.jpg" src="/assets/images/shop/products/hmgoepprod7.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="black">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod8.jpg" src="/assets/images/shop/products/hmgoepprod8.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="black">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod9.jpg" src="/assets/images/shop/products/hmgoepprod9.jpg" alt="img-product" />
                          </div>
                        </div>
                        {/* blue */}
                        <div className="swiper-slide stagger-item" data-color="blue">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod10.jpg" src="/assets/images/shop/products/hmgoepprod10.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="blue">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod11.jpg" src="/assets/images/shop/products/hmgoepprod11.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="blue">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod12.jpg" src="/assets/images/shop/products/hmgoepprod12.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="blue">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod13.jpg" src="/assets/images/shop/products/hmgoepprod13.jpg" alt="img-product" />
                          </div>
                        </div>
                        {/* white */}
                        <div className="swiper-slide stagger-item" data-color="white">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod14.jpg" src="/assets/images/shop/products/hmgoepprod14.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="white">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod15.jpg" src="/assets/images/shop/products/hmgoepprod15.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="white">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod16.jpg" src="/assets/images/shop/products/hmgoepprod16.jpg" alt="img-product" />
                          </div>
                        </div>
                        <div className="swiper-slide stagger-item" data-color="white">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod17.jpg" src="/assets/images/shop/products/hmgoepprod17.jpg" alt="img-product" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                      <div className="swiper-wrapper">
                        ...
                        <div className="swiper-slide" data-color="beige">
                          <a href="images/shop/products/p-d1.png" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                        ...
                        <div className="swiper-slide" data-color="blue">
                          <a href="images/shop/products/hmgoepprod10.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod10.jpg" data-src="/assets/images/shop/products/hmgoepprod10.jpg" src="/assets/images/shop/products/hmgoepprod10.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="blue">
                          <a href="images/shop/products/hmgoepprod11.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod11.jpg" data-src="/assets/images/shop/products/hmgoepprod11.jpg" src="/assets/images/shop/products/hmgoepprod11.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="blue">
                          <a href="images/shop/products/hmgoepprod12.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod12.jpg" data-src="/assets/images/shop/products/hmgoepprod12.jpg" src="/assets/images/shop/products/hmgoepprod12.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="blue">
                          <a href="images/shop/products/hmgoepprod13.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod13.jpg" data-src="/assets/images/shop/products/hmgoepprod13.jpg" src="/assets/images/shop/products/hmgoepprod13.jpg" alt="img-product" />
                          </a>
                        </div>
                        {/* white */}
                        <div className="swiper-slide" data-color="white">
                          <a href="images/shop/products/hmgoepprod14.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod14.jpg" data-src="/assets/images/shop/products/hmgoepprod14.jpg" src="/assets/images/shop/products/hmgoepprod14.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="white">
                          <a href="images/shop/products/hmgoepprod15.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod15.jpg" data-src="/assets/images/shop/products/hmgoepprod15.jpg" src="/assets/images/shop/products/hmgoepprod15.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="white">
                          <a href="images/shop/products/hmgoepprod16.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod16.jpg" data-src="/assets/images/shop/products/hmgoepprod16.jpg" src="/assets/images/shop/products/hmgoepprod16.jpg" alt="img-product" />
                          </a>
                        </div>
                        <div className="swiper-slide" data-color="white">
                          <a href="images/shop/products/hmgoepprod17.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod17.jpg" data-src="/assets/images/shop/products/hmgoepprod17.jpg" src="/assets/images/shop/products/hmgoepprod17.jpg" alt="img-product" />
                          </a>
                        </div>
                      </div>
                    ...
                    <div className="tf-product-info-variant-picker">
                      <div className="variant-picker-item">
                        <div className="variant-picker-label">
                          Color: <span className="fw-6 variant-picker-label-value value-currentColor">Beige</span>
                        </div>
                        <div className="variant-picker-values">
                          <input id="values-beige" type="radio" name="color1" defaultChecked />
                          <label className="hover-tooltip radius-60 color-btn" htmlFor="values-beige" data-color="beige" data-value="Beige">
                            <span className="btn-checkbox bg-color-beige" />
                            <span className="tooltip">Beige</span>
                          </label>
                          <input id="values-black" type="radio" name="color1" />
                          <label className=" hover-tooltip radius-60 color-btn" data-price={9} htmlFor="values-black" data-color="black" data-value="Black">
                            <span className="btn-checkbox bg-color-black" />
                            <span className="tooltip">Black</span>
                          </label>
                          <input id="values-blue" type="radio" name="color1" />
                          <label className="hover-tooltip radius-60 color-btn" data-price={10} htmlFor="values-blue" data-color="blue" data-value="Blue">
                            <span className="btn-checkbox bg-color-blue" />
                            <span className="tooltip">Blue</span>
                          </label>
                          <input id="values-white" type="radio" name="color1" />
                          <label className="hover-tooltip radius-60 color-btn" data-price={12} htmlFor="values-white" data-color="white" data-value="White">
            ...
            <div className="tf-height-observer w-100 d-flex align-items-center">
              <div className="tf-sticky-atc-product d-flex align-items-center">
                <div className="tf-sticky-atc-img">
                  <img className="lazyloaded" data-src="/assets/images/shop/products/p-d1.png" alt src="/assets/images/shop/products/p-d1.png" />
                </div>
                ...
                <div className="col-xl-3 col-md-6 col-12">
                  <div className="footer-infor">
                    ...
                    <ul className="tf-social-icon d-flex gap-10">
                      <li><a href="#" className="box-icon w_34 round social-facebook social-line"><i className="icon fs-14 icon-fb" /></a></li>
                      <li><a href="#" className="box-icon w_34 round social-twiter social-line"><i className="icon fs-12 icon-Icon-x" /></a></li>
                      <li><a href="#" className="box-icon w_34 round social-instagram social-line"><i className="icon fs-14 icon-instagram" /></a></li>
                      <li><a href="#" className="box-icon w_34 round social-tiktok social-line"><i className="icon fs-14 icon-tiktok" /></a></li>
                      <li><a href="#" className="box-icon w_34 round social-pinterest social-line"><i className="icon fs-14 icon-pinterest-1" /></a></li>
                    </ul>
                  </div>
                </div>
      ...
      <div className="btn-sidebar-mobile d-flex start-0">
        <button className="type-hover" data-bs-toggle="offcanvas" data-bs-target="#sidebarmobile" aria-controls="offcanvasRight">
    ...
    <div className="offcanvas offcanvas-start canvas-filter canvas-sidebar" id="sidebarmobile">
      <div className="canvas-wrapper">
        ...
        <div className="canvas-body">
          <aside className="tf-shop-sidebar">
            <div className="widget-facet">
              <div className="facet-title" data-bs-target="#shipping" data-bs-toggle="collapse" aria-expanded="true" aria-controls="shipping">
            ...
            <div className="widget-facet">
              <div className="facet-title" data-bs-target="#sale-products" data-bs-toggle="collapse" aria-expanded="true" aria-controls="sale-products">
                ...
                <div className="widget-featured-products mb_36">
                  <div className="featured-product-item">
                    <a href="product-detail.html" className="card-product-wrapper">
                      <img className="img-product lazyload" data-src="/assets/images/products/img-feature-1.png" alt="image-feature" src="/assets/images/products/img-feature-1.png" />
                    </a>
                    <div className="card-product-info">
                  ...
                  <div className="featured-product-item">
                    <a href="product-detail.html" className="card-product-wrapper">
                      <img className="img-product lazyload" data-src="/assets/images/products/img-feature-2.png" alt="image-feature" src="/assets/images/products/img-feature-2.png" />
                    </a>
                    <div className="card-product-info">
                  ...
                  <div className="featured-product-item">
                    <a href="product-detail.html" className="card-product-wrapper">
                      <img className="img-product lazyload" data-src="/assets/images/products/img-feature-3.png" alt="image-feature" src="/assets/images/products/img-feature-3.png" />
                    </a>
                    <div className="card-product-info">
              ...
              <div id="gallery" className="collapse show">
                <div className="grid-3 gap-4 mb_36">
                  <a href="product-detail.html" className="item-gallery">
                    <img className="lazyload" data-src="/assets/images/shop/gallery/gallery-1.jpg" alt="img-gallery" src="/assets/images/shop/gallery/gallery-1.jpg" />
                  </a>
                  <a href="product-detail.html" className="item-gallery">
                    <img className="lazyload" data-src="/assets/images/shop/gallery/gallery-2.jpg" alt="img-gallery" src="/assets/images/shop/gallery/gallery-2.jpg" />
                  </a>
                  <a href="product-detail.html" className="item-gallery">
                    <img className="lazyload" data-src="/assets/images/shop/gallery/gallery-3.jpg" src="/assets/images/shop/gallery/gallery-3.jpg" alt="img-gallery" />
                  </a>
                  <a href="product-detail.html" className="item-gallery">
                    <img className="lazyload" data-src="/assets/images/shop/gallery/gallery-4.jpg" alt="img-gallery" src="/assets/images/shop/gallery/gallery-4.jpg" />
                  </a>
                  <a href="product-detail.html" className="item-gallery">
                    <img className="lazyload" data-src="/assets/images/shop/gallery/gallery-5.jpg" src="/assets/images/shop/gallery/gallery-5.jpg" alt="img-gallery" />
                  </a>
                  <a href="product-detail.html" className="item-gallery">
                    <img className="lazyload" data-src="/assets/images/shop/gallery/gallery-6.jpg" src="/assets/images/shop/gallery/gallery-6.jpg" alt="img-gallery" />
                  </a>
                </div>
              </div>
            </div>
            <div className="widget-facet">
              ...
              <div id="follow" className="collapse show">
                <ul className="tf-social-icon d-flex gap-10">
                  <li><a href="#" className="box-icon w_34 round bg_line social-facebook"><i className="icon fs-14 icon-fb" /></a></li>
                  <li><a href="#" className="box-icon w_34 round bg_line social-twiter"><i className="icon fs-12 icon-Icon-x" /></a></li>
                  <li><a href="#" className="box-icon w_34 round bg_line social-instagram"><i className="icon fs-14 icon-instagram" /></a></li>
                  <li><a href="#" className="box-icon w_34 round bg_line social-tiktok"><i className="icon fs-14 icon-tiktok" /></a></li>
                  <li><a href="#" className="box-icon w_34 round bg_line social-pinterest"><i className="icon fs-14 icon-pinterest-1" /></a></li>
                </ul>
              </div>
            </div>
          </aside>
