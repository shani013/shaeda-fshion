                    ...
                    <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                      <div className="swiper-wrapper">
                        ...
                        <div className="swiper-slide" data-color="white">
                          <a href="images/products/white-2.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/white-2.jpg" data-src="/assets/images/products/white-2.jpg" src="/assets/images/products/white-2.jpg" alt="img-product" />
                          </a>
                        </div>
                        {/* pink */}
                        <div className="swiper-slide" data-color="pink">
                          <a href="images/products/pink-1.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/pink-1.jpg" data-src="/assets/images/products/pink-1.jpg" src="/assets/images/products/pink-1.jpg" alt="img-product" />
                          </a>
                        </div>
                        {/* black */}
                        <div className="swiper-slide" data-color="black">
                          <a href="images/products/black-2.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                            <img className="tf-image-zoom lazyload" data-zoom="images/products/black-2.jpg" data-src="/assets/images/products/black-2.jpg" src="/assets/images/products/black-2.jpg" alt />
                          </a>
                        </div>
                      </div>
                    ...
                    <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                      <div className="swiper-wrapper stagger-wrap">
                        ...
                        <div className="swiper-slide stagger-item" data-color="white">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/white-2.jpg" src="/assets/images/products/white-2.jpg" alt="img-product" />
                          </div>
                        </div>
                        {/* pink */}
                        <div className="swiper-slide stagger-item" data-color="pink">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/pink-1.jpg" src="/assets/images/products/pink-1.jpg" alt="img-product" />
                          </div>
                        </div>
                        {/* black */}
                        <div className="swiper-slide stagger-item" data-color="black">
                          <div className="item">
                            <img className="lazyload" data-src="/assets/images/products/black-2.jpg" src="/assets/images/products/black-2.jpg" alt="img-product" />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="tf-product-info-wrap position-relative">
                  ...
                  <div className="tf-product-info-list other-image-zoom">
                    ...
                    <div className="tf-product-info-liveview">
                      <div className="liveview-count">11</div>
                      <p className="fw-6">People are viewing this right now</p>
                    </div>
                    <div className="tf-product-info-variant-picker">
                      <div className="variant-picker-item">
                        <div className="variant-picker-label">
                          Color: <span className="fw-6 variant-picker-label-value value-currentColor">White</span>
                        </div>
                        <div className="variant-picker-values">
                          <input id="values-white" type="radio" name="color1" defaultChecked />
                          ...
                          <label className=" hover-tooltip radius-60 color-btn" data-color="pink" htmlFor="values-pink" data-value="Pink">
                            <span className="btn-checkbox bg_pink" />
                          ...
                          <label className="hover-tooltip radius-60 color-btn" data-color="black" htmlFor="values-black" data-value="Black">
                            <span className="btn-checkbox bg_dark" />
