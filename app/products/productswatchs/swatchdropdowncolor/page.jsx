                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          ...
                          <div className="tf-dropdown-sort full position-relative has-color" data-bs-toggle="dropdown">
                            <div className="btn-select">
                              <span className="text-sort-value select-currentColor">Beige</span>
                              <span className="icon icon-arrow-down" />
                            </div>
                            <div className="dropdown-menu">
                              <div className="select-item active color-btn" data-color="beige">
                                <span className="box-color d-inline-block rounded-full bg_beige" />
                                <span className="text-value-item">Beige</span>
                              </div>
                              <div className="select-item color-btn" data-color="pink" data-price={10}>
                                <span className="box-color d-inline-block rounded-full bg_pink" />
                                <span className="text-value-item">Pink</span>
                              </div>
                              <div className="select-item color-btn" data-color="blue" data-price={12}>
                                <span className="box-color d-inline-block rounded-full bg_blue" />
                                <span className="text-value-item">Blue</span>
                              </div>
                              <div className="select-item color-btn" data-color="brown" data-price={14}>
                        ...
                        <div className="variant-picker-item">
                          ...
                          <div className="tf-dropdown-sort full position-relative" data-bs-toggle="dropdown">
                            ...
                            <div className="dropdown-menu">
                              <div className="select-item select-size size-btn active" data-value="M">
                                <span className="text-value-item">M</span>
                              </div>
                              <div className="select-item select-size size-btn" data-price={14} data-value="L">
                                <span className="text-value-item">L</span>
                              </div>
                              <div className="select-item select-size size-btn" data-price={16} data-value="XL">
