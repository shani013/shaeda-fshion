                      ...
                      <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                        <div className="swiper-wrapper stagger-wrap">
                          ...
                          <div className="swiper-slide stagger-item" data-color="beige">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/beige.jpg" src="/assets/images/products/beige.jpg" alt="img-product" />
                            </div>
                          </div>
                          {/* pink */}
                          <div className="swiper-slide stagger-item" data-color="pink">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/pink-2.jpg" src="/assets/images/products/pink-2.jpg" alt="img-product" />
                            </div>
                          </div>
                          {/* blue */}
                          <div className="swiper-slide stagger-item" data-color="blue">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/blue.jpg" src="/assets/images/products/blue.jpg" alt="img-product" />
                            </div>
                          </div>
                          {/* brown */}
                      ...
                      <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                        <div className="swiper-wrapper">
                          ...
                          <div className="swiper-slide" data-color="beige">
                            <a href="images/products/beige.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/beige.jpg" data-src="/assets/images/products/beige.jpg" src="/assets/images/products/beige.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* pink */}
                          <div className="swiper-slide" data-color="pink">
                            <a href="images/products/pink-2.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/pink-2.jpg" data-src="/assets/images/products/pink-2.jpg" src="/assets/images/products/pink-2.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* blue */}
                          <div className="swiper-slide" data-color="blue">
                            <a href="images/products/blue.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom lazyload" data-zoom="images/products/blue.jpg" data-src="/assets/images/products/blue.jpg" src="/assets/images/products/blue.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* brown */}
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            <input type="radio" name="color1" id="values-beige" defaultChecked />
                            <label className="style-text rectangle-color color-btn" data-color="beige" htmlFor="values-beige" data-value="Beige">
                              <span className="d-inline-block rounded-full bg_beige" />
                              <p>Beige</p>
                            </label>
                            <input type="radio" name="color1" id="values-pink" />
                            <label className="style-text rectangle-color color-btn" data-price={10} data-color="pink" htmlFor="values-pink" data-value="Pink">
                              <span className="d-inline-block rounded-full bg_pink" />
                              <p>Pink</p>
                            </label>
                            <input type="radio" name="color1" id="values-blue" />
                            <label className="style-text rectangle-color color-btn" data-price={12} data-color="blue" htmlFor="values-blue" data-value="Blue">
                              <span className="d-inline-block rounded-full bg_blue" />
                              <p>Blue</p>
                            </label>
                            <input type="radio" name="color1" id="values-brown" />
                            <label className="style-text rectangle-color color-btn" data-price={14} data-color="brown" htmlFor="values-brown" data-value="Brown">
                              <span className="d-inline-block rounded-full bg_brown" />
                              <p>Brown</p>
                            </label>
                          </div>
                        </div>
