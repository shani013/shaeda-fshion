                    ...
                    <div className="tf-product-info-variant-picker">
                      <div className="variant-picker-item">
                        ...
                        <div className="variant-picker-values">
                          ...
                          <label className="hover-tooltip image-rounded radius-60 color-btn" data-color="beige" htmlFor="values-beige" data-value="Beige">
                          ...
                          <label className=" hover-tooltip image-rounded radius-60 color-btn" data-color="black" data-price={10} htmlFor="values-black" data-value="Black">
                            <span className="btn-checkbox">
                          ...
                          <label className="hover-tooltip image-rounded radius-60 color-btn" data-color="blue" data-price={12} htmlFor="values-blue" data-value="Blue">
                            <span className="btn-checkbox">
                          ...
                          <label className="hover-tooltip image-rounded radius-60 color-btn" data-color="white" data-price={16} htmlFor="values-white" data-value="White">
                            <span className="btn-checkbox">
                      ...
                      <div className="variant-picker-item">
                        ...
                        <div className="variant-picker-values">
                          ...
                          <label className="style-text size-btn" data-price={10} htmlFor="values-m" data-value="M">
                            <p>M</p>
                          </label>
                          <input type="radio" name="size1" id="values-l" />
                          <label className="style-text size-btn" data-price={12} htmlFor="values-l" data-value="L">
                            <p>L</p>
                          </label>
                          <input type="radio" name="size1" id="values-xl" />
                          <label className="style-text size-btn" data-price={14} htmlFor="values-xl" data-value="XL">
                            <p>XL</p>
                          </label>
                        </div>
                      </div>
