                      ...
                      <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                        <div className="swiper-wrapper stagger-wrap">
                          ...
                          <div className="swiper-slide stagger-item" data-color="beige">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod31.jpg" src="/assets/images/shop/products/hmgoepprod31.jpg" alt />
                            </div>
                          </div>
                          <div className="swiper-slide stagger-item" data-color="beige">
                            <div className="item">
                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-price">
                        <div className="price-on-sale text_black">$18.00</div>
                      </div>
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          <div className="variant-picker-label">
                            Choose: <span className="fw-6 variant-picker-label-value value-currentColor">Beige</span>
                          </div>
                          <div className="variant-picker-values">
                            <input type="radio" name="color1" id="color-1" defaultChecked />
                            <label className="style-image hover-tooltip color-btn" data-color="beige" htmlFor="color-1" data-value="Beige">
                              <div>
                                <div className="image">
                                  <img className=" lazyloaded" data-src="/assets/images/shop/products/hmgoepprod.jpg" alt src="/assets/images/shop/products/hmgoepprod.jpg" />
                                </div>
                              </div>
                              <span className="tooltip">Beige</span>
                            </label>
                            <input type="radio" name="color1" id="color-2" />
                            <label className="style-image hover-tooltip color-btn" data-color="black" htmlFor="color-2" data-value="Black">
                              <div>
                                <div className="image">
                                  <img className=" lazyloaded" data-src="/assets/images/shop/products/hmgoepprod6.jpg" alt src="/assets/images/shop/products/hmgoepprod6.jpg" />
                                </div>
                              </div>
