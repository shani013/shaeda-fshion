                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-price">
                        <div className="price-on-sale">$20.00</div>
                        <div className="compare-at-price">$40.00</div>
                        <div className="badges-on-sale"><span>17</span>% OFF</div>
                      </div>
                      <div className="tf-product-info-liveview">
                        <div className="liveview-count">40</div>
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            <input type="radio" name="color1" id="values-white" defaultChecked />
                            <label className="style-text color-btn" data-color="white" htmlFor="values-white" data-value="White">
                              <p>White</p>
                            </label>
                            <input type="radio" name="color1" id="values-pink" />
                            <label className="style-text color-btn" data-color="pink" data-price={22} htmlFor="values-pink" data-value="Pink">
                              <p>Pink</p>
                            </label>
                            <input type="radio" name="color1" id="values-black" />
                            <label className="style-text color-btn" data-color="black" data-price={24} htmlFor="values-black" data-value="Black">
                              <p>Black</p>
                            </label>
                          </div>
                        </div>
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            ...
                            <label className="style-text size-btn" data-price={22} htmlFor="values-m" data-value="M">
                              <p>M</p>
                            </label>
                            <input type="radio" name="size1" id="values-l" />
                            <label className="style-text size-btn" data-price={24} htmlFor="values-l" data-value="L">
                              <p>L</p>
                            </label>
                            <input type="radio" name="size1" id="values-xl" />
                            <label className="style-text size-btn" data-price={26} htmlFor="values-xl" data-value="XL">
                              <p>XL</p>
                            </label>
                          </div>
                        </div>
                      ...
                      <div className="tf-product-info-buy-button">
                        <form className>
                          <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$20.00</span></a>
