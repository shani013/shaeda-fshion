                ...
                <div className="col-md-6">
                  <div className="tf-product-media-wrap sticky-top">
                    <div className="thumbs-slider">
                      <div dir="ltr" className="swiper tf-product-media-thumbs" data-direction="vertical">
                      ...
                      <div dir="ltr" className="swiper tf-product-media-main tf-product-zoom-inner" id="gallery-swiper-started">
                        <div className="swiper-wrapper">
                          ...
                          <div className="swiper-slide" data-color="brown">
                            <a href="images/products/brown.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom-inner lazyload" data-zoom="images/products/brown.jpg" data-src="/assets/images/products/brown.jpg" src="/assets/images/products/brown.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* purple */}
                          <div className="swiper-slide" data-color="purple">
                            <a href="images/products/purple.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom-inner lazyload" data-zoom="images/products/purple.jpg" data-src="/assets/images/products/purple.jpg" src="/assets/images/products/purple.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* light green */}
                          <div className="swiper-slide" data-color="green">
                            <a href="images/products/green.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom-inner lazyload" data-zoom="images/products/green.jpg" data-src="/assets/images/products/green.jpg" src="/assets/images/products/green.jpg" alt="img-product" />
                            </a>
                          </div>
                        </div>
                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list">
                      ...
                      <div className="tf-product-info-price">
                        ...
                        <div className="badges-on-sale"><span>17</span>% OFF</div>
                      </div>
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            ...
                            <label className=" hover-tooltip radius-60 color-btn" data-color="purple" data-price={22} htmlFor="values-purple" data-value="Purple">
                              <span className="btn-checkbox bg_purple" />
                              <span className="tooltip">Purple</span>
                            </label>
                            <input id="values-green" type="radio" name="color1" />
                            <label className="hover-tooltip radius-60 color-btn" data-color="green" data-price={20} htmlFor="values-green" data-value="Light Green">
                        ...
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            <input type="radio" name="size1" id="values-m" defaultChecked />
                            <label className="style-text size-btn" htmlFor="values-m" data-value="M">
                              <p>M</p>
                            </label>
                            <input type="radio" name="size1" id="values-l" />
                            <label className="style-text size-btn" data-price={26} htmlFor="values-l" data-value="L">
                              <p>L</p>
                            </label>
                            <input type="radio" name="size1" id="values-xl" />
                            <label className="style-text size-btn" data-price={27} htmlFor="values-xl" data-value="XL">
                              <p>XL</p>
                            </label>
                          </div>
                        </div>
                      ...
                      <div className="tf-product-info-buy-button">
                        <form className>
                          <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$25.00</span></a>
