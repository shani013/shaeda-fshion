          ...
          <div className="container">
            <div className="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
              <div className="tf-breadcrumb-list">
                ...
                <span className="text">Gift Card</span>
              </div>
                ...
                <div className="col-md-6">
                  <div className="tf-product-media-wrap sticky-top">
                    <div className="other-image-zoom" id="gallery-swiper-started">
                      <a href="images/shop/products/gift-card-1.png" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                        <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/gift-card-1.png" data-src="/assets/images/shop/products/gift-card-1.png" src="/assets/images/shop/products/gift-card-1.png" alt />
                      </a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="tf-product-info-wrap position-relative">
                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-price">
                        <div className="text-black price-on-sale">$10.00</div>
                      </div>
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          <div className="variant-picker-label">
                            Denominations: <span className="fw-6 variant-picker-label-value">$10</span>
                          </div>
                          <div className="variant-picker-values">
                            <input type="radio" name="size1" id="values-1" defaultChecked />
                            <label className="style-text size-btn" data-price={10} htmlFor="values-1" data-value="$10">
                              <p>$10</p>
                            </label>
                            <input type="radio" name="size1" id="values-2" />
                            <label className="style-text size-btn" data-price={25} htmlFor="values-2" data-value="$25">
                              <p>$25</p>
                            </label>
                            <input type="radio" name="size1" id="values-3" />
                            <label className="style-text size-btn" data-price={50} htmlFor="values-3" data-value="$50">
                              <p>$50</p>
                            </label>
                            <input type="radio" name="size1" id="values-4" />
                            <label className="style-text size-btn" data-price={100} htmlFor="values-4" data-value="$100">
                              <p>$100</p>
                            </label>
                          </div>
                        </div>
                            ...
                            <div className="wrap-content w-100">
                              <div className="tf-product-form">
                                <div className="tf-field">
                                  <input className="tf-field-input tf-input" placeholder=" " type="email" id="property1" name="properties[email]" />
                                  <label className="tf-field-label" htmlFor="property1">Recipient email</label>
                                </div>
                                <div className="tf-field">
                                  <input className="tf-field-input tf-input" placeholder=" " type="text" id="property2" name="properties[name]" />
                                  <label className="tf-field-label" htmlFor="property2">Recipient name (optional)</label>
                                </div>
                                <div className="tf-field">
                                  <textarea className="tf-field-input tf-input" name="note" id="property3" placeholder defaultValue={""} />
                                  <label className="tf-field-label" htmlFor="property3">Message (optional)</label>
                                  <p className="text-end">200 characters max</p>
                                </div>
                                <div className="tf-field style-1">
                                  <input className="fw-6" type="date" name="date" defaultValue />
                                  <label className="tf-field-label" htmlFor>Send on (optional)</label>
                                </div>
                              </div>
                            </div>
                          </div>
                          <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$10.00</span></a>
