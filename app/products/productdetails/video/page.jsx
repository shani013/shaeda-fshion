const { default: Footer2 } = require("@/app/component/footer2");
const { default: Header2 } = require("@/app/component/header2");
                ...
                <div className="thumbs-slider">
                    ...
                    <div className="swiper-wrapper">
                      ...
                      <div className="swiper-slide" data-color="beige">
                        <div className="item position-relative">
                          ...
                          <img className="lazyload" data-src="/assets/images/shop/products/preview_images/img-video-1.jpg" src="/assets/images/shop/products/preview_images/img-video-1.jpg" alt />
                        </div>
                      </div>
                      {/* black */}
                  ...
                  <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                    <div className="swiper-wrapper">
                      ...
                      <div className="swiper-slide" data-color="beige">
                        <div className="item">
                          <video playsInline="true" autoPlay preload="metadata" muted controls loop src="/assets/images/shop/products/preview_images/video-1.mp4" />
                        </div>
                      </div>
                      {/* black */}
                      <div className="swiper-slide" data-color="black">
              ...
              <div className="tf-product-info-wrap position-relative">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  ...
                  <div className="tf-product-info-buy-button">
                    <form className>
                      <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price" data-price={8.00}>$8.00</span></a>
