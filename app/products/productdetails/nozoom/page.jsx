              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="tf-product-media-wrap sticky-top">
                    <div className="thumbs-slider thumbs-default">
                      <div dir="ltr" className="swiper tf-product-media-thumbs tf-product-media-thumbs-default" data-direction="vertical">
                      ...
                      <div dir="ltr" className="swiper tf-product-media-main tf-product-media-main-default">
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            ...
                            <label className="hover-tooltip radius-60 color-btn active" data-color="white" htmlFor="values-white" data-value="White">
