                      ...
                      <div dir="ltr" className="swiper tf-product-media-thumbs" data-direction="vertical">
                        <div className="swiper-wrapper stagger-wrap">
                          ...
                          <div className="swiper-slide stagger-item" data-color="green">
                            <div className="item">
                              <img className="lazyload" data-src="/assets/images/products/green.jpg" src="/assets/images/products/green.jpg" alt="img-compare" />
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="swiper-wrapper">
                          ...
                          <div className="swiper-slide" data-color="brown">
                            <a href="images/products/brown.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom-magnifier lazyload" data-zoom="images/products/brown.jpg" data-src="/assets/images/products/brown.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* purple */}
                          <div className="swiper-slide" data-color="purple">
                            <a href="images/products/purple.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom-magnifier lazyload" data-zoom="images/products/purple.jpg" data-src="/assets/images/products/purple.jpg" alt="img-product" />
                            </a>
                          </div>
                          {/* light green */}
                          <div className="swiper-slide" data-color="green">
                            <a href="images/products/green.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                              <img className="tf-image-zoom-magnifier lazyload" data-zoom="images/products/green.jpg" data-src="/assets/images/products/green.jpg" alt="img-product" />
                            </a>
                          </div>
                        </div>
