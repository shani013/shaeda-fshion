                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          <div className="variant-picker-label">
                            Choose: <span className="fw-6 variant-picker-label-value value-currentName">Cotton jersey top</span>
                          </div>
                          <div className="variant-picker-values">
                            <input type="radio" name="image" id="image-1" defaultChecked />
                            <label className="style-image hover-tooltip color-btn" data-color="beige" htmlFor="image-1" data-value="Cotton jersey top">
                              <a href="#">
                                <div className="image">
                                  <img className=" lazyload" data-src="/assets/images/shop/products/hmgoepprod.jpg" alt src="/assets/images/shop/products/hmgoepprod.jpg" />
                                </div>
                                <p className="value-name">Cotton jersey top</p>
                              </a>
                              <span className="tooltip">Cotton jersey top</span>
                            </label>
                            <input type="radio" name="image" id="image-2" />
                            <label className="style-image hover-tooltip color-btn" data-color="black" htmlFor="image-2" data-value="Slim Fit Fine-knit Turtleneck Sweater">
                              <a href="#">
                                <div className="image">
                                  <img className=" lazyload" data-src="/assets/images/shop/products/hmgoepprod6.jpg" alt src="/assets/images/shop/products/hmgoepprod6.jpg" />
                                </div>
                                <p className="value-name">Slim Fit Fine-knit Turtleneck Sweater</p>
                              </a>
                              <span className="tooltip">Slim Fit Fine-knit Turtleneck Sweater</span>
                            </label>
                            <input type="radio" name="image" id="image-3" />
                            <label className="style-image hover-tooltip color-btn" data-color="blue" htmlFor="image-3" data-value="Ribbed Tank Top">
                              <a href="#">
                                <div className="image">
                                  <img className=" lazyload" data-src="/assets/images/shop/products/hmgoepprod10.jpg" alt src="/assets/images/shop/products/hmgoepprod10.jpg" />
                                </div>
                                <p className="value-name">Ribbed Tank Top</p>
                              </a>
                              <span className="tooltip">Ribbed Tank Top</span>
                            </label>
                          </div>
                        </div>
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            ...
                            <label className="hover-tooltip radius-60 color-btn" data-color="beige" htmlFor="values-beige" data-value="Beige">
                              <span className="btn-checkbox bg-color-beige" />
                              <span className="tooltip">Beige</span>
                            </label>
                            <input id="values-black" type="radio" name="color1" />
                            <label className=" hover-tooltip radius-60 color-btn" data-color="black" htmlFor="values-black" data-value="Black">
                              <span className="btn-checkbox bg-color-black" />
                              <span className="tooltip">Black</span>
                            </label>
                            <input id="values-blue" type="radio" name="color1" />
                            <label className="hover-tooltip radius-60 color-btn" data-color="blue" htmlFor="values-blue" data-value="Blue">
