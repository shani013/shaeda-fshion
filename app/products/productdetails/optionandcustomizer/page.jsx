                    ...
                    <div className="tf-product-info-list other-image-zoom">
                      ...
                      <div className="tf-product-info-variant-picker">
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            ...
                            <label className=" hover-tooltip radius-60 color-btn" htmlFor="values-black" data-color="black" data-value="Black">
                              <span className="btn-checkbox bg-color-black" />
                              <span className="tooltip">Black</span>
                            </label>
                            <input id="values-blue" type="radio" name="color1" />
                            <label className="hover-tooltip radius-60 color-btn" htmlFor="values-blue" data-color="blue" data-value="Blue">
                              <span className="btn-checkbox bg-color-blue" />
                              <span className="tooltip">Blue</span>
                            </label>
                            <input id="values-white" type="radio" name="color1" />
                            <label className="hover-tooltip radius-60 color-btn" htmlFor="values-white" data-color="white" data-value="White">
                        ...
                        <div className="variant-picker-item">
                          ...
                          <div className="variant-picker-values">
                            ...
                            <label className="style-text size-btn" htmlFor="values-m" data-value="M">
                              <p>M</p>
                            </label>
                            <input type="radio" name="size1" id="values-l" />
                            <label className="style-text size-btn" htmlFor="values-l" data-value="L">
                              <p>L</p>
                            </label>
                            <input type="radio" name="size1" id="values-xl" />
                            <label className="style-text size-btn" htmlFor="values-xl" data-value="XL">
                              <p>XL</p>
                            </label>
                          </div>
                        </div>
                      ...
                      <div className="tf-product-item-property">
                        <div className="tf-field">
                          <input className="tf-field-input tf-input" placeholder=" " type="text" id="property1" name="properties[Personalize]" />
                          <label className="tf-field-label" htmlFor="property1">Personalize</label>
                        </div>
                      </div>
                      <div className="tf-product-item-property">
                        <div className="tf-field">
                          <input className="tf-field-input tf-input" placeholder=" " type="text" id="property2" name="properties[Write your text]" />
                          <label className="tf-field-label" htmlFor="property2">Write your text</label>
                        </div>
                      </div>
                      ...
                      <div className="tf-product-info-buy-button">
                        <form className>
                          <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$18.00</span></a>
