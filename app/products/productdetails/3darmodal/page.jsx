              ...
              <div className="tf-product-media-wrap sticky-top">
                <div className="thumbs-slider">
                  <div dir="ltr" className="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="item">
                          <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod18.jpg" src="/assets/images/shop/products/hmgoepprod18.jpg" alt />
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="item">
                          <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod19.jpg" src="/assets/images/shop/products/hmgoepprod19.jpg" alt />
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="item">
                          <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod20.jpg" src="/assets/images/shop/products/hmgoepprod20.jpg" alt />
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="item position-relative">
                          <div className="wrap-btn-viewer">
                            <i className="icon-btn3d" />
                          </div>
                          <img className="lazyload" data-src="/assets/images/shop/products/preview_images/img-3d-1.jpg" src="/assets/images/shop/products/preview_images/img-3d-1.jpg" alt />
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="item">
                          <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod21.jpg" src="/assets/images/shop/products/hmgoepprod21.jpg" alt />
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="item">
                          <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod22.jpg" src="/assets/images/shop/products/hmgoepprod22.jpg" alt />
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="item">
                          <img className="lazyload" data-src="/assets/images/shop/products/hmgoepprod23.jpg" src="/assets/images/shop/products/hmgoepprod23.jpg" alt />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div dir="ltr" className="swiper tf-product-media-main" id="gallery-swiper-started">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <a href="images/shop/products/hmgoepprod18.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                          <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod18.jpg" data-src="/assets/images/shop/products/hmgoepprod18.jpg" src="/assets/images/shop/products/hmgoepprod18.jpg" alt />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        <a href="images/shop/products/hmgoepprod19.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                          <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod19.jpg" data-src="/assets/images/shop/products/hmgoepprod19.jpg" src="/assets/images/shop/products/hmgoepprod19.jpg" alt />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        <a href="images/shop/products/hmgoepprod20.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                          <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod20.jpg" data-src="/assets/images/shop/products/hmgoepprod20.jpg" src="/assets/images/shop/products/hmgoepprod20.jpg" alt />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        <div className="item">
                          <div className="tf-model-viewer">
                            <model-viewer reveal="auto" toggleable="true" data-model-id={36168614805808} src="/assets/images/shop/products/preview_images/dance-bag_3d.html" camera-controls="true" data-shopify-feature="1.12" alt="Alice Mini - Dusty Rose" poster="images/shop/products/preview_images/img-3d-1.jpg" className="tf-model-viewer-ui disabled" tabIndex={1} data-js-focus-visible ar-status="not-presenting">
                            </model-viewer>
                      ...
                      <div className="swiper-slide">
                        <a href="images/shop/products/hmgoepprod21.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                          <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod21.jpg" data-src="/assets/images/shop/products/hmgoepprod21.jpg" src="/assets/images/shop/products/hmgoepprod21.jpg" alt />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        <a href="images/shop/products/hmgoepprod22.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                          <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod22.jpg" data-src="/assets/images/shop/products/hmgoepprod22.jpg" src="/assets/images/shop/products/hmgoepprod22.jpg" alt />
                        </a>
                      </div>
                      <div className="swiper-slide">
                        <a href="images/shop/products/hmgoepprod23.jpg" target="_blank" className="item" data-pswp-width="770px" data-pswp-height="1075px">
                          <img className="tf-image-zoom lazyload" data-zoom="images/shop/products/hmgoepprod23.jpg" data-src="/assets/images/shop/products/hmgoepprod23.jpg" src="/assets/images/shop/products/hmgoepprod23.jpg" alt />
                        </a>
                      </div>
                    </div>
              ...
              <div className="tf-product-info-wrap position-relative">
                ...
                <div className="tf-product-info-list other-image-zoom">
                  ...
                  <div className="tf-product-info-liveview">
                    <div className="liveview-count">35</div>
                  ...
                  <div className="tf-product-info-buy-button">
                    <form className>
                      <a href="javascript:void(0);" className="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span className="tf-qty-price total-price">$138.00</span></a>
