      ...
      <div className="container">
        ...
        <div className="wrapper-control-shop">
          ...
          <div className="tf-grid-layout wrapper-shop tf-col-4" id="gridLayout">
            {/* card product 1 */}
            <div className="card-product style-4 grid" data-availability="In stock" data-brand="Ecomus">
              <div className="card-product-wrapper">
            ...
            {/* card product 9 */}
            <div className="card-product style-4 grid" data-availability="In stock" data-brand="M&H">
              <div className="card-product-wrapper">
                <a href="product-detail.html" className="product-img">
            ...
            {/* card product 11 */}
            <div className="card-product style-4 grid" data-availability="Out of stock" data-brand="M&H">
              <div className="card-product-wrapper">
                <a href="product-detail.html" className="product-img">
