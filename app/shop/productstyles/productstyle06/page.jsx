      ...
      <div className="container">
        ...
        <div className="wrapper-control-shop">
          ...
          <div className="tf-grid-layout wrapper-shop tf-col-4" id="gridLayout">
            {/* card product 1 */}
            <div className="card-product style-6 grid" data-availability="In stock" data-brand="Ecomus">
              <div className="card-product-wrapper">
                ...
                <div className="list-product-btn">
                  <a href="javascript:void(0);" className="box-icon wishlist bg_white round btn-icon-action">
                    <span className="icon icon-heart" />
                    <span className="tooltip">Add to Wishlist</span>
                    <span className="icon icon-delete" />
                  </a>
                  <a href="#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" className="box-icon compare bg_white round btn-icon-action">
                    <span className="icon icon-compare" />
                    <span className="tooltip">Add to Compare</span>
                    <span className="icon icon-check" />
                  </a>
                  <a href="#quick_view" data-bs-toggle="modal" className="box-icon quickview bg_white round tf-btn-loading">
              ...
              <div className="card-product-info">
                ...
                <a href="#quick_add" data-bs-toggle="modal" className="btn-quick-add quick-add">QUICK ADD</a>
              </div>
            </div>
            {/* card product 2 */}
            <div className="card-product style-6 grid" data-availability="In stock" data-brand="Ecomus">
            ...
            <div className="card-product style-6 grid" data-availability="In stock" data-brand="Ecomus">
              ...
              <div className="card-product-info">
                ...
                <span className="price current-price">$10.00</span>
                <a href="#shoppingCart" data-bs-toggle="modal" className="btn-quick-add quick-add tf-btn-loading">
            ...
            {/* card product 9 */}
            <div className="card-product style-6 grid" data-availability="In stock" data-brand="M&H">
              <div className="card-product-wrapper">
                <a href="product-detail.html" className="product-img">
            ...
            {/* card product 11 */}
            <div className="card-product style-6 grid" data-availability="Out of stock" data-brand="M&H">
              <div className="card-product-wrapper">
                <a href="product-detail.html" className="product-img">
