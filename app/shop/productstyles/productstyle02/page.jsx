      ...
      <div className="container">
        ...
        <div className="wrapper-control-shop">
          ...
          <div className="tf-grid-layout wrapper-shop tf-col-4" id="gridLayout">
            {/* card product 1 */}
            <div className="card-product style-2 grid" data-availability="In stock" data-brand="Ecomus">
              <div className="card-product-wrapper">
                ...
                <div className="list-product-btn column-left">
                  <a href="javascript:void(0);" className="box-icon wishlist bg_white btn-icon-action">
                ...
                <div className="list-product-btn absolute-3">
                  <a href="#quick_add" data-bs-toggle="modal" className="box-icon quick-add style-2">
                    <span className="icon icon-bag" />
                    <span className="text">QUICK ADD</span>
                  </a>
                  <a href="#quick_view" data-bs-toggle="modal" className="box-icon quickview style-2">
            ...
            <div className="card-product style-2 grid" data-availability="In stock" data-brand="Ecomus">
              ...
              <div className="card-product-info">
                ...
                <ul className="list-color-product">
                  ...
                  <li className="list-color-item color-swatch">
                    <span className="tooltip">Light Green</span>
                    <span className="swatch-value bg_light_green" />
                    <img className="lazyload" data-src="/assets/images/products/green.jpg" src="/assets/images/products/green.jpg" alt="image-product" />
                  </li>
                </ul>
              </div>
            ...
            <div className="card-product style-2 grid" data-availability="In stock" data-brand="Ecomus">
              <div className="card-product-wrapper">
                ...
                <div className="list-product-btn absolute-2">
                  <a href="#shoppingCart" data-bs-toggle="modal" className="box-icon quick-add style-2">
                    <span className="icon icon-bag" />
            ...
            {/* card product 9 */}
            <div className="card-product style-2 grid" data-availability="In stock" data-brand="M&H">
              <div className="card-product-wrapper">
                <a href="product-detail.html" className="product-img">
            ...
            {/* card product 11 */}
            <div className="card-product style-2 grid" data-availability="Out of stock" data-brand="M&H">
              <div className="card-product-wrapper">
                <a href="product-detail.html" className="product-img">
