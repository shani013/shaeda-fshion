      ...
      <div className="container">
        ...
        <div className="wrapper-control-shop">
          ...
          <div className="tf-grid-layout wrapper-shop tf-col-4" id="gridLayout">
            {/* card product 1 */}
            <div className="card-product style-5 grid" data-availability="In stock" data-brand="Ecomus">
              <div className="card-product-wrapper">
                ...
                <div className="list-product-btn gap-0">
                  <a href="#quick_add" data-bs-toggle="modal" className="box-icon bg_white quick-add tf-btn-loading shadow-none">
                    <span className="icon icon-bag" />
                    <span className="tooltip">Quick Add</span>
                  </a>
                  <a href="javascript:void(0);" className="box-icon bg_white wishlist btn-icon-action shadow-none">
                    <span className="icon icon-heart" />
                    <span className="tooltip">Add to Wishlist</span>
                    <span className="icon icon-delete" />
                  </a>
                  <a href="#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" className="box-icon bg_white compare btn-icon-action shadow-none">
                    <span className="icon icon-compare" />
                    <span className="tooltip">Add to Compare</span>
                    <span className="icon icon-check" />
                  </a>
                  <a href="#quick_view" data-bs-toggle="modal" className="box-icon bg_white quickview tf-btn-loading shadow-none">
            ...
            <div className="card-product style-5 grid" data-availability="In stock" data-brand="Ecomus">
              <div className="card-product-wrapper">
                ...
                <div className="list-product-btn gap-0 absolute-2">
                  <a href="#quick_add" data-bs-toggle="modal" className="box-icon bg_white quick-add tf-btn-loading shadow-none">
                    <span className="icon icon-bag" />
                    <span className="tooltip">Quick Add</span>
                  </a>
            ...
            {/* card product 9 */}
            <div className="card-product style-5 grid" data-availability="In stock" data-brand="M&H">
              <div className="card-product-wrapper">
                <a href="product-detail.html" className="product-img">
            ...
            {/* card product 11 */}
            <div className="card-product style-5 grid" data-availability="Out of stock" data-brand="M&H">
              <div className="card-product-wrapper">
                <a href="product-detail.html" className="product-img">
