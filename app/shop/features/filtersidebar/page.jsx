                ...
                <div className="widget-facet wd-categories">
                  ...
                  <div id="categories" className="collapse show">
                    <ul className="list-categoris current-scrollbar mb_36">
                      <li className="cate-item current"><a href="#"><span>Fashion</span></a></li>
                      <li className="cate-item"><a href="#"><span>Men</span></a></li>
                      <li className="cate-item"><a href="#"><span>Women</span></a></li>
                      <li className="cate-item"><a href="#"><span>Denim</span></a></li>
                      <li className="cate-item"><a href="#"><span>Dress</span></a></li>
                    </ul>
                  </div>
                </div>
