          ...
          <div className="container">
            ...
            <div className="wrapper-control-shop">
              ...
              <div className="tf-list-layout wrapper-shop" id="listLayout">
                {/* card product 1 */}
                <div
                  className="loadItem card-product list-layout"
                ...
                {/* Load Item */}
                <button
                  id="infiniteScrollList"
                  className="tf-loading-default loading tf-loading"
                />
              </div>
              <div
              ...
              >
                {/* card product 1 */}
                <div
                  className="loadItem card-product grid"
                  data-availability="In stock"
                  data-brand="Ecomus"
                >
                  <div className="card-product-wrapper">
