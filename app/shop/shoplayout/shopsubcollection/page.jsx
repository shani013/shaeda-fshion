...
export default function page() {
  return (
        ...
        <section className="flat-spacing-3 pb_0">
            <div className="container">
                <div className="hover-sw-nav">
                    <div dir="ltr" className="swiper tf-sw-collection swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden" data-preview="5" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="30" data-space="15" data-loop="false" data-auto-play="false">
                        <div className="swiper-wrapper" id="swiper-wrapper-0f4c217e63d9db67" aria-live="polite" style={{transform: "translate3d(0px, 0px, 0px)"}}>
                            <div className="swiper-slide swiper-slide-active" lazy="true" role="group" aria-label="1 / 6" style={{width: "264px", marginRight: "30px"}}>
                                <div className="collection-item style-2 hover-img">
                                    <div className="collection-inner">
                                        <a href="shop-default.html" className="collection-image img-style">
                                            <img className=" ls-is-cached lazyloaded" data-src="/assets/images/collections/collection-14.jpg" src="/assets/images/collections/collection-14.jpg" alt="collection-img" />
                                        </a>
                                        <div className="collection-content">
                                            <a href="shop-default.html" className="tf-btn collection-title hover-icon fs-15"><span>Accessories</span><i className="icon icon-arrow1-top-left"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="swiper-slide swiper-slide-next" lazy="true" role="group" aria-label="2 / 6" style={{width: "264px", marginRight: "30px"}}>
                                <div className="collection-item style-2 hover-img">
                                    <div className="collection-inner">
                                        <a href="shop-default.html" className="collection-image img-style">
                                            <img className=" ls-is-cached lazyloaded" data-src="/assets/images/collections/collection-15.jpg" src="/assets/images/collections/collection-15.jpg" alt="collection-img" />
                                        </a>
                                        <div className="collection-content">
                                            <a href="shop-default.html" className="tf-btn collection-title hover-icon fs-15"><span>Men</span><i className="icon icon-arrow1-top-left"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="swiper-slide" lazy="true" role="group" aria-label="3 / 6" style={{width: "264px", marginRight: "30px"}}>
                                <div className="collection-item style-2 hover-img">
                                    <div className="collection-inner">
                                        <a href="shop-default.html" className="collection-image img-style">
                                            <img className=" ls-is-cached lazyloaded" data-src="/assets/images/collections/collection-16.jpg" src="/assets/images/collections/collection-16.jpg" alt="collection-demo-1" />
                                        </a>
                                        <div className="collection-content">
                                            <a href="shop-default.html" className="tf-btn collection-title hover-icon fs-15"><span>Shoes</span><i className="icon icon-arrow1-top-left"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="swiper-slide" lazy="true" role="group" aria-label="4 / 6" style={{width: "264px", marginRight: "30px"}}>
                                <div className="collection-item style-2 hover-img">
                                    <div className="collection-inner">
                                        <a href="shop-default.html" className="collection-image img-style">
                                            <img className=" ls-is-cached lazyloaded" data-src="/assets/images/collections/collection-17.jpg" src="/assets/images/collections/collection-17.jpg" alt="collection-demo-1" />
                                        </a>
                                        <div className="collection-content">
                                            <a href="shop-default.html" className="tf-btn collection-title hover-icon fs-15"><span>New Arrival</span><i className="icon icon-arrow1-top-left"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="swiper-slide" lazy="true" role="group" aria-label="5 / 6" style={{width: "264px", marginRight: "30px"}}>
                                <div className="collection-item style-2 hover-img">
                                    <div className="collection-inner">
                                        <a href="shop-default.html" className="collection-image img-style">
                                            <img className=" ls-is-cached lazyloaded" data-src="/assets/images/collections/collection-18.jpg" src="/assets/images/collections/collection-18.jpg" alt="collection-demo-1" />
                                        </a>
                                        <div className="collection-content">
                                            <a href="shop-default.html" className="tf-btn collection-title hover-icon fs-15"><span>Handbag</span><i className="icon icon-arrow1-top-left"></i></a>
                                        </div>
                                    </div>
                                </div>   
                            </div>
                            <div className="swiper-slide" lazy="true" role="group" aria-label="6 / 6" style={{width: "264px", marginRight: "30px"}}>
                                <div className="collection-item style-2 hover-img">
                                    <div className="collection-inner">
                                        <a href="shop-default.html" className="collection-image img-style">
                                            <img className=" ls-is-cached lazyloaded" data-src="/assets/images/collections/collection-19.jpg" src="/assets/images/collections/collection-19.jpg" alt="collection-demo-1" />
                                        </a>
                                        <div className="collection-content">
                                            <a href="shop-default.html" className="tf-btn collection-title hover-icon fs-15"><span>Women</span><i className="icon icon-arrow1-top-left"></i></a>
                                        </div>
                                    </div>
                                </div>   
                            </div>
                    ...
                    <div className="nav-sw nav-next-slider nav-next-collection box-icon w_46 round swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-0f4c217e63d9db67" aria-disabled="true"><span className="icon icon-arrow-left"></span></div>
                    <div className="nav-sw nav-prev-slider nav-prev-collection box-icon w_46 round" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-0f4c217e63d9db67" aria-disabled="false"><span className="icon icon-arrow-right"></span></div>
                    <div className="sw-dots style-2 sw-pagination-collection justify-content-center swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal"><span className="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1" aria-current="true"></span><span className="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span></div>
                </div>
            </div>
        </section>
        {/* /Collection */}
    ...
    <div className="progress-wrap">
        ...
        <path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98" style={{transition: "strokeDashoffset 10ms linear 0s", strokeDasharray: "307.919, 307.919", strokeDashoffset: "286.138"}}></path>
        </svg>
    </div>
    {/* /gotop */}
