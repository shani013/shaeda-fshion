              ...
              <div className="hover-sw-nav">
                ...
                >
                  <div
                    ...
                    id="swiper-wrapper-0f4c217e63d9db67"
                    aria-live="polite"
                  ...
                  >
                    <div
                      ...
                      role="group"
                      aria-label="1 / 6"
                      style={{ width: "264px", marginRight: "30px" }}
                    >
                        ...
                        <div className="collection-inner">
                          ...
                          >
                            <img
                              ...
                              data-src="/assets/images/collections/collection-14.jpg"
                              src="/assets/images/collections/collection-14.jpg"
                              alt="collection-img"
                            />
                          </a>
                      ...
                      <div className="collection-item style-2 hover-img">
                        <div className="collection-inner">
                          ...
                          >
                            <img
                              className=" ls-is-cached lazyloaded"
                              data-src="/assets/images/collections/collection-17.jpg"
                              src="/assets/images/collections/collection-17.jpg"
                              alt="collection-demo-1"
                            />
                          </a>
                          <div className="collection-content">
                      ...
                      <div className="collection-item style-2 hover-img">
                        <div className="collection-inner">
                          ...
                          >
                            <img
                              className=" ls-is-cached lazyloaded"
                              data-src="/assets/images/collections/collection-18.jpg"
                              src="/assets/images/collections/collection-18.jpg"
                              alt="collection-demo-1"
                            />
                          </a>
                          <div className="collection-content">
                      ...
                      <div className="collection-item style-2 hover-img">
                        <div className="collection-inner">
                          ...
                          >
                            <img
                              className=" ls-is-cached lazyloaded"
                              data-src="/assets/images/collections/collection-19.jpg"
                              src="/assets/images/collections/collection-19.jpg"
                              alt="collection-demo-1"
                            />
                          </a>
                          <div className="collection-content">
                ...
                <div
                  className="nav-sw nav-next-slider nav-next-collection box-icon w_46 round swiper-button-disabled"
                  tabindex="-1"
                  role="button"
                  aria-label="Previous slide"
                  aria-controls="swiper-wrapper-0f4c217e63d9db67"
                  aria-disabled="true"
                >
                  <span className="icon icon-arrow-left"></span>
                </div>
                <div
                  className="nav-sw nav-prev-slider nav-prev-collection box-icon w_46 round"
                  tabindex="0"
                  role="button"
                ...
                <div className="sw-dots style-2 sw-pagination-collection justify-content-center swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
                  <span
