    ...
    return (
        ...
        <div id="wrapper">
                ...
                <div className="container">
                    <div className="tf-shop-control grid-3 align-items-center">
                        ...
                        <ul className="tf-control-layout d-flex justify-content-center">
                            ...
                            <li className="tf-view-layout-switch sw-layout-3 active" data-value-layout="tf-col-3">
                                <div className="item"><span className="icon icon-grid-3"></span></div>
                            </li>
                            <li className="tf-view-layout-switch sw-layout-4" data-value-layout="tf-col-4">
                    ...
                    <div className="tf-row-flex">
                            ...
                            <div className="widget-facet wd-categories">
                                ...
                                <div id="categories" className="collapse show">
                                    <ul className="list-categoris current-scrollbar mb_36">
                                        <li className="cate-item current"><a href="#"><span>Fashion</span>&nbsp;<span>(31)</span></a></li>
                                        <li className="cate-item"><a href="#"><span>Men</span>&nbsp;<span>(9)</span></a></li>
                                        <li className="cate-item"><a href="#"><span>Women</span>&nbsp;<span>(23)</span></a></li>
                                        <li className="cate-item"><a href="#"><span>Denim</span>&nbsp;<span>(20)</span></a></li>
                                        <li className="cate-item"><a href="#"><span>Dress</span>&nbsp;<span>(23)</span></a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div className="widget-featured-products mb_36">
                                        <div className="featured-product-item">
                                            <a href="product-detail.html" className="card-product-wrapper">
                                                <img className="lazyload img-product" data-src="/assets/images/products/img-feature-1.png" alt="image-feature" />
                                            </a>
                                        ...
                                        <div className="featured-product-item">
                                            <a href="product-detail.html" className="card-product-wrapper">
                                                <img className="lazyload img-product" data-src="/assets/images/products/img-feature-2.png" alt="image-feature" />
                                            </a>
                                            <div className="card-product-info">
                                        ...
                                        <div className="featured-product-item">
                                            <a href="product-detail.html" className="card-product-wrapper">
                                                <img className="lazyload img-product" data-src="/assets/images/products/img-feature-3.png" alt="image-feature" />
                                            </a>
                                            <div className="card-product-info">
                                ...
                                <div id="gallery" className="collapse show">
                                    <div className="grid-3 gap-4 mb_36">
                                        <a href="product-detail.html" className="item-gallery">
                                            <img className="lazyload" src="/assets/images/shop/gallery/gallery-1.jpg" alt="img-gallery" />
                                        </a>
                                        <a href="product-detail.html" className="item-gallery">
                                            <img className="lazyload" src="/assets/images/shop/gallery/gallery-2.jpg" alt="img-gallery" />
                                        </a>
                                        <a href="product-detail.html" className="item-gallery">
                                            <img className="lazyload" src="/assets/images/shop/gallery/gallery-3.jpg" 
                                             alt="img-gallery" />
                                        </a>
                                        <a href="product-detail.html" className="item-gallery">
                                            <img className="lazyload" src="/assets/images/shop/gallery/gallery-4.jpg" alt="img-gallery" />
                                        </a>
                                        <a href="product-detail.html" className="item-gallery">
                            ...
                            <div className="widget-facet">
                                ...
                                <div id="follow" className="collapse show">
                                    <ul className="tf-social-icon d-flex gap-10">
                                        <li><a href="#" className="box-icon w_34 round bg_line social-facebook"><i className="icon fs-14 icon-fb"></i></a></li>
                                        <li><a href="#" className="box-icon w_34 round bg_line social-twiter"><i className="icon fs-12 icon-Icon-x"></i></a></li>
                                        <li><a href="#" className="box-icon w_34 round bg_line social-instagram"><i className="icon fs-14 icon-instagram"></i></a></li>
                                        <li><a href="#" className="box-icon w_34 round bg_line social-tiktok"><i className="icon fs-14 icon-tiktok"></i></a></li>
                                        <li><a href="#" className="box-icon w_34 round bg_line social-pinterest"><i className="icon fs-14 icon-pinterest-1"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </aside>
                        <div className="wrapper-control-shop tf-shop-content">
                            <div className="meta-filter-shop">
                                ...
                                <button id="remove-all" className="remove-all-filters" style={{display: "none"}}>Remove All <i className="icon icon-close"></i></button>
                            </div>
                            <div className="tf-list-layout wrapper-shop" id="listLayout">
                                ...
                                <div className="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                                    ...
                                    <div className="card-product-info">
                                        ...
                                        <div className="list-product-btn">
                                            <a href="#quick_add" data-bs-toggle="modal" className="box-icon quick-add style-3 hover-tooltip"><span className="icon icon-bag"></span><span className="tooltip">Quick add</span></a>
                                            <a href="#" className="box-icon wishlist style-3 hover-tooltip"><span className="icon icon-heart"></span> <span className="tooltip">Add to Wishlist</span></a>
                                            <a href="#compare" data-bs-toggle="offcanvas" className="box-icon compare style-3 hover-tooltip"><span className="icon icon-compare"></span> <span className="tooltip">Add to Compare</span></a>
                                            <a href="#quick_view" data-bs-toggle="modal" className="box-icon quickview style-3 hover-tooltip"><span className="icon icon-view"></span><span className="tooltip">Quick view</span></a>
                                        </div>
                                    </div>
                                </div>
                                {/* card product 2 */}
                                <div className="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                                    ...
                                    <div className="card-product-info">
                                        ...
                                        <div className="list-product-btn">
                                            <a href="#quick_add" data-bs-toggle="modal" className="box-icon quick-add style-3"><span className="icon icon-bag"></span><span className="tooltip">Quick add</span></a>
                                            <a href="#" className="box-icon wishlist style-3"><span className="icon icon-heart"></span> <span className="tooltip">Add to Wishlist</span></a>
                                            <a href="#compare" data-bs-toggle="offcanvas" className="box-icon compare style-3"><span className="icon icon-compare"></span> <span className="tooltip">Add to Compare</span></a>
                                            <a href="#quick_view" data-bs-toggle="modal" className="box-icon quickview style-3"><span className="icon icon-view"></span><span className="tooltip">Quick view</span></a>
                                        </div>
                                    </div>
                                </div>
                                {/* card product 3 */}
            ...
            <div className="btn-sidebar-style2">
                <button data-bs-toggle="offcanvas" data-bs-target="#sidebarmobile" aria-controls="offcanvas"><i className="icon icon-sidebar-2"></i></button>
            </div>
                        ...
                        <div className="row-demo">
                            ...
                            <div className="demo-item position-relative">
                                <a href="home-personalized-pod.html">
                                    <div className="demo-image">
                                        <img className="lazyload" data-src="images/demo/home-personalized-pod.jpg" src="images/demo/home-personalized-pod.jpg" alt="home-personalized-pod" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item position-relative">
                                <a href="home-pickleball.html">
                                    <div className="demo-image">
                                        <img className="lazyload" data-src="images/demo/home-pickleball.png" src="images/demo/home-pickleball.png" alt="home-pickleball" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item position-relative">
                                <a href="home-ceramic.html">
                                    <div className="demo-image">
                                        <img className="lazyload" data-src="images/demo/home-ceramic.png" src="images/demo/home-ceramic.png" alt="home-ceramic" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item position-relative">
                                <a href="home-food.html">
                                    <div className="demo-image">
                                        <img className="lazyload" data-src="images/demo/home-food.png" src="images/demo/home-food.png" alt="home-food" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item position-relative">
                                <a href="home-camp-and-hike.html">
                                    <div className="demo-image">
                                        <img className="lazyload" data-src="images/demo/home-camp-and-hike.png" src="images/demo/home-camp-and-hike.png" alt="home-camp-and-hike" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item">
                                <a href="home-cosmetic.html">
                                    <div className="demo-image position-relative">
                                        <img className="lazyload" data-src="images/demo/home-cosmetic.png" src="images/demo/home-cosmetic.png" alt="home-cosmetic" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item">
                                <a href="home-plant.html">
                                    <div className="demo-image position-relative">
                                        <img className="lazyload" data-src="images/demo/home-plant.png" src="images/demo/home-plant.png" alt="home-plant" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item">
                                <a href="home-swimwear.html">
                                    <div className="demo-image position-relative">
                                        <img className="lazyload" data-src="images/demo/home-swimwear.png" src="images/demo/home-swimwear.png" alt="home-swimwear" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item">
                                <a href="home-electric-bike.html">
                                    <div className="demo-image position-relative">
                                        <img className="lazyload" data-src="images/demo/home-electric-bike.png" src="images/demo/home-electric-bike.png" alt="home-electric-bike" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item">
                                <a href="home-footwear.html">
                                    <div className="demo-image position-relative">
                                        <img className="lazyload" data-src="images/demo/home-footwear.jpg" src="images/demo/home-footwear.jpg" alt="home-footwear" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item">
                                <a href="home-book-store.html">
                                    <div className="demo-image position-relative">
                                        <img className="lazyload" data-src="images/demo/home-bookstore.png" src="images/demo/home-bookstore.png" alt="home-bookstore" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div className="demo-item">
                                <a href="home-gaming-accessories.html">
                                    <div className="demo-image position-relative">
                                        <img className="lazyload" data-src="images/demo/home-gaming-accessories.png" src="images/demo/home-gaming-accessories.png" alt="home-gaming-accessories" />
                                        <div className="demo-label">
                                            <span className="demo-new">New</span>
                                        </div>
                                    </div>
                            ...
                            <div id="availability" className="collapse show">
                                <ul className="tf-filter-group current-scrollbar mb_36">
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        ...
                                        <label for="inStock" className="label"><span>In stock</span>&nbsp;<span>(14)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="availability" className="tf-check" id="outStock"/>
                                        <label for="outStock" className="label"><span>Out of stock</span>&nbsp;<span>(2)</span></label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div id="brand" className="collapse show">
                                <ul className="tf-filter-group current-scrollbar mb_36">
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        ...
                                        <label for="Ecomus" className="label"><span>Ecomus</span>&nbsp;<span>(8)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="brand" className="tf-check" id="M&H"/>
                                        <label for="M&H" className="label"><span>M&H</span>&nbsp;<span>(8)</span></label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div id="color" className="collapse show">
                                <ul className="tf-filter-group filter-color current-scrollbar mb_36">
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        ...
                                        <label for="Beige" className="label"><span>Beige</span>&nbsp;<span>(3)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_dark" id="Black" value="Black"/>
                                        <label for="Black" className="label"><span>Black</span>&nbsp;<span>(18)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_blue-2" id="Blue" value="Blue"/>
                                        <label for="Blue" className="label"><span>Blue</span>&nbsp;<span>(3)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_brown" id="Brown" value="Brown"/>
                                        <label for="Brown" className="label"><span>Brown</span>&nbsp;<span>(3)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_cream" id="Cream" value="Cream"/>
                                        <label for="Cream" className="label"><span>Cream</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_dark-beige" id="Dark Beige" value="Dark Beige"/>
                                        <label for="Dark Beige" className="label"><span>Dark Beige</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_dark-blue" id="Dark Blue" value="Dark Blue"/>
                                        <label for="Dark Blue" className="label"><span>Dark Blue</span>&nbsp;<span>(3)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_dark-green" id="Dark Green" value="Dark Green"/>
                                        <label for="Dark Green" className="label"><span>Dark Green</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_dark-grey" id="Dark Grey" value="Dark Grey"/>
                                        <label for="Dark Grey" className="label"><span>Dark Grey</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_grey" id="Grey" value="Grey"/>
                                        <label for="Grey" className="label"><span>Grey</span>&nbsp;<span>(2)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_light-blue" id="Light Blue" value="Light Blue"/>
                                        <label for="Light Blue" className="label"><span>Light Blue</span>&nbsp;<span>(5)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_light-green" id="Light Green" value="Light Green"/>
                                        <label for="Light Green" className="label"><span>Light Green</span>&nbsp;<span>(3)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_light-grey" id="Light Grey" value="Light Grey"/>
                                        <label for="Light Grey" className="label"><span>Light Grey</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_light-pink" id="Light Pink" value="Light Pink"/>
                                        <label for="Light Pink" className="label"><span>Light Pink</span>&nbsp;<span>(2)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_purple" id="Light Purple" value="Light Purple"/>
                                        <label for="Light Purple" className="label"><span>Light Purple</span>&nbsp;<span>(2)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_light-yellow" id="Light Yellow" value="Light Yellow"/>
                                        <label for="Light Yellow" className="label"><span>Light Yellow</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_orange" id="Orange" value="Orange"/>
                                        <label for="Orange" className="label"><span>Orange</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_pink" id="Pink" value="Pink"/>
                                        <label for="Pink" className="label"><span>Pink</span>&nbsp;<span>(2)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_taupe" id="Taupe" value="Taupe"/>
                                        <label for="Taupe" className="label"><span>Taupe</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_white" id="White" value="White"/>
                                        <label for="White" className="label"><span>White</span>&nbsp;<span>(14)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="color" className="tf-check-color bg_yellow" id="Yellow" value="Yellow"/>
                                        <label for="Yellow" className="label"><span>Yellow</span>&nbsp;<span>(1)</span></label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div id="size" className="collapse show">
                                <ul className="tf-filter-group current-scrollbar">
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        ...
                                        <label for="S" className="label"><span>S</span>&nbsp;<span>(7)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="size" className="tf-check tf-check-size" value="M" id="M"/>
                                        <label for="M" className="label"><span>M</span>&nbsp;<span>(8)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="size" className="tf-check tf-check-size" value="L" id="L"/>
                                        <label for="L" className="label"><span>L</span>&nbsp;<span>(8)</span></label>
                                    </li>
                                    <li className="list-item d-flex gap-12 align-items-center">
                                        <input type="radio" name="size" className="tf-check tf-check-size" value="XL" id="XL"/>
                                        <label for="XL" className="label"><span>XL</span>&nbsp;<span>(6)</span></label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="tf-login-form">
                        <form className="" action="https://themesflat.co/html/ecomus/my-account.html" accept-charset="utf-8">
                            <div className="tf-field style-1">
                                ...
                                <label className="tf-field-label" for="">Email *</label>
                            </div>
                            <div className="tf-field style-1">
                                <input className="tf-field-input tf-input" placeholder=" " type="password"  name=""/>
                                <label className="tf-field-label" for="">Password *</label>
                            </div>
                            <div>
                    ...
                    <div className="tf-login-form">
                        <form className="">
                            <div className="tf-field style-1">
                                ...
                                <label className="tf-field-label" for="">First name</label>
                            </div>
                            <div className="tf-field style-1">
                                <input className="tf-field-input tf-input" placeholder=" " type="text"  name=""/>
                                <label className="tf-field-label" for="">Last name</label>
                            </div>
                            <div className="tf-field style-1">
                                <input className="tf-field-input tf-input" placeholder=" " type="email"  name=""/>
                                <label className="tf-field-label" for="">Email *</label>
                                ...
                                <div className="tf-product-info-variant-picker">
                                    <div className="variant-picker-item">
                                        ...
                                        <div className="variant-picker-values">
                                            ...
                                            <label className="hover-tooltip radius-60" for="values-orange-1" data-value="Orange">
                                                <span className="btn-checkbox bg-color-orange"></span>
                                                <span className="tooltip">Orange</span>
                                            </label>
