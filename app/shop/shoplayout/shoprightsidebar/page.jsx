...
export default function page() {
  return (
    ...
    <div id="wrapper">
                                ...
                                <div className="widget-featured-products mb_36">
                                    <div className="featured-product-item">
                                        <a href="product-detail.html" className="card-product-wrapper">
                                            <img className="lazyload img-product" src="/assets/images/products/img-feature-1.png" alt="image-feature" />
                                        </a>
                                        <div className="card-product-info">
                                    ...
                                    <div className="featured-product-item">
                                        <a href="product-detail.html" className="card-product-wrapper">
                                            <img className="lazyload img-product" src="/assets/images/products/img-feature-2.png" alt="image-feature" />
                                        </a>
                                        <div className="card-product-info">
                                    ...
                                    <div className="featured-product-item">
                                        <a href="product-detail.html" className="card-product-wrapper">
                                            <img className="lazyload img-product" src="/assets/images/products/img-feature-3.png" alt="image-feature" />
                                        </a>
                                        <div className="card-product-info">
                        ...
                        <div className="widget-facet">
                            ...
                            <div id="gallery" className="collapse show">
                                <div className="grid-3 gap-4 mb_36">
                                    ...
                                    <a href="product-detail.html" className="item-gallery">
                                        <img className="lazyload" src="/assets/images/shop/gallery/gallery-3.jpg" alt="img-gallery" />
                                    </a>
                                    <a href="product-detail.html" className="item-gallery">
        ...
        <div className="btn-sidebar-style2 right">
    ...
    {/* /modal find_size */}
    {/* <!-- sidebar--> */}
    <div className="offcanvas offcanvas-end canvas-filter canvas-sidebar" id="sidebarmobile">
        <div className="canvas-wrapper">
            <header className="canvas-header">
